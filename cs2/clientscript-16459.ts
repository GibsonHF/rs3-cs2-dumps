...
function script16459(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): number {
    ...
    var int8 = -1;
    [int8, int2] = script14749(int0, 0, int2, int3, 0);
    var int9 = int2;
    ...
    var int14 = (int2 - int9);
    int10 = (4 + 4);
    var int15 = (((35 + 2) + 2) + enum_getvalue(25, 0, 8549, 26));
    int14 = MAX(int14, int15);
    int2 = (int9 + ((((int14 - (35 + 2)) - enum_getvalue(25, 0, 8549, 26)) - (2 * 2)) / 2));
