//
function script4546(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number): void {
    if (((int2 == 0) || (int2 == 1))) {
        if (((IF_GETWIDTH(int0) + int5) <= int1)) {
    ...
    if (((int2 == 2) || (int2 == 3))) {
        if (((IF_GETHEIGHT(int0) + int5) <= int1)) {
