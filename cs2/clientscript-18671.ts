//
function script18671(int0: number, int1: number, string0: string): string {
    ...
    string0 = `${string0}<br>- <sprite=30074><nbsp><col=ffffff>${struct_getparam(48314, 2794)}:</col> ${script17711(17, 1)}.`;
