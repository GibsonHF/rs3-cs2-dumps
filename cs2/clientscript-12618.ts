//
function script12618(int0: number, string0: string): string {
    var int1 = script8247(19343);
    ...
    string0 = `${string0}<br>- <sprite=14236><nbsp><col=ffffff>${struct_getparam(14730, 2794)}:</col> Deals ${script17720(14730, 260, (260 + 50), 0, 0)}.`;
    if ((int1 == 45450)) {
