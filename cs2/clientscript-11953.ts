//
function script11953(int0: number, int1: number, int2: number): void {
    ...
    var string1 = "";
    var string2 = "";
    [string1, string2] = FRIEND_GETNAME(int4);
    string1 = LOWERCASE(string1);
    while ((int6 < int2)) {
        [string0, string2] = FRIEND_GETNAME(push_array(int6));
    ...
    pop_array(int5, int4);
    if ((int1 < (int5 - 1))) {
        script11953(0, int1, (int5 - 1));
    };
    if (((int5 + 1) < int2)) {
        script11953(0, (int5 + 1), int2);
    };
    return;
}