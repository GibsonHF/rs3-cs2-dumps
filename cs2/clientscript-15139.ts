//
function script15139(int0: number, int1: number): [number, string] {
    if (((int0 == -1 as dbrow) || (DB_GETROWTABLE(int0) != 106))) {
        return [0, ""];
    };
    if (((script4148() == 1) && (dbrow_getfield(int0, 434336, 0) == 0))) {
        return [2, "This item isn't available to ironmen."];
    };
    if ((script15140(int0) == 1)) {
        return [3, "You already own this item. You can't craft it again."];
    };
    var int2 = script15124(int0);
    if ((((int2 != -1 as obj) && (OC_MEMBERS(int2) == 1)) && (PLAYERMEMBER() == 0))) {
