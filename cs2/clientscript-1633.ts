...
function script1633(string0: string): void {
    ...
    string0 = script2332(string0, " ", " ");
    while ((STRING_INDEXOF_STRING(string0, " ", 0) == 0)) {
        if ((int0 > 0)) {
            string0 = SUBSTRING(string0, 1, int0);
            int0 = STRING_LENGTH(string0);
        };
        while ((STRING_INDEXOF_STRING(string0, " ", (int0 - 1)) == (int0 - 1))) {
            if ((int0 > 0)) {
            ...
            while ((STRING_INDEXOF_STRING(string0, " ", 0) == 0)) {
                ...
                while ((STRING_INDEXOF_STRING(string0, " ", (int0 - 1)) == (int0 - 1))) {
                    ...
                    string1 = script2332(string1, " ", " ");
                    while ((STRING_INDEXOF_STRING(string1, " ", 0) == 0)) {
                        if ((int0 > 0)) {
                        ...
                        while ((STRING_INDEXOF_STRING(string0, " ", (int0 - 1)) == (int0 - 1))) {
                            ...
                            while ((STRING_INDEXOF_STRING(string1, " ", 0) == 0)) {
                                ...
                                while ((STRING_INDEXOF_STRING(string1, " ", (int0 - 1)) == (int0 - 1))) {
                                    if ((int0 > 0)) {
                                        string1 = SUBSTRING(string1, 0, (int0 - 1));
                                        int0 = STRING_LENGTH(string1);
                                    };
                ...
                string1 = LOWERCASE(REMOVETAGS(CHAT_PLAYERNAME_UNFILTERED()));
                int0 = STRING_LENGTH(string1);
                string1 = script2332(string1, "_", " ");
                string1 = script2332(string1, "-", " ");
                string1 = script2332(string1, " ", " ");
