//
function script7238(int0: number, int1: number, int2: number, int3: number, int4: number, string0: string): number {
    ...
    if ((int3 == comp(1486, 14))) {  // text_tooltip:tooltip_dynamic_text
        int9 = 350;
