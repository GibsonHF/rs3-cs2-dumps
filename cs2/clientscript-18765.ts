//
function script18765(int0: number, int1: number, string0: string): string {
    ...
    string0 = `${string0}<br>- ${script17712(120, 0)} for each <sprite=15190><nbsp><col=ffffff>${struct_getparam(49562, 2794)}</col> stack.`;
