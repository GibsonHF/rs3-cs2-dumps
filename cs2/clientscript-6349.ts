...
function script6349(int0: number, int1: number, int2: number): [number, number] {
    ...
    var int4 = -1;
    if ((int2 != -1)) {
        if (((int2 < 128) || (int2 > 1000))) {
            [int0, int1] = script8064(int2);
        } else {
            switch (int2) {
                case 150: {
                ...
                case 157: {
                    [int0, int1] = script8065(1, 1);
                    break;
                }
                case 180: {
                    [int0, int1] = script8065(1, 6);
                    break;
                }
                case 185: {
                    [int0, int1] = script8065(1, 3);
                    break;
                }
                case 156: {
                ...
                case 175: {
                    [int0, int1] = script8066(29);
                    break;
                }
                case 195: {
                    [int0, int1] = script8065(3, 1);
                    break;
                }
                case 176: {
                    [int0, int1] = script8065(3, 2);
                    break;
                }
                case 177: {
                ...
                case 178: {
                    [int0, int1] = script8065(1, 5);
                    break;
                }
                case 179: {
                    [int0, int1] = script8065(3, 3);
                    break;
                }
                case 181: {
                ...
                case 192: {
                    [int0, int1] = script8065(8, 1);
                    break;
                }
                case 193: {
                    [int0, int1] = script8065(0, 2);
                    break;
                }
                case 194: {
                    [int0, int1] = script8065(4, 6);
                    break;
                }
                case 219: {
