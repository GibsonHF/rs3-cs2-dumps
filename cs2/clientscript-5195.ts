...
function script5195(): void {
    ...
    IF_SETGRAPHIC(7653, 73531442);
    IF_SETGRAPHIC(7652, 73531471);
    IF_SETGRAPHIC(7652, 73531475);
    IF_SETGRAPHIC(7652, 73531479);
    IF_SETGRAPHIC(7652, 73531483);
