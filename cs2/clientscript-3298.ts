//
function script3298(int0: stat, int1: component, int2: component, int3: unknown_int): void {
    ...
    IF_SETONOP(callback(script3737, int0, int4, int1, int3), int1);
    return;
}