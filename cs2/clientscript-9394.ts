//
function script9394(int0: number, int1: number, int2: number): void {
    ...
    var int13 = 0;
    var int14 = 0;
    var int15 = IF_GETWIDTH(comp(365, 16));  // settings:set_scrolling
    var int16 = 0;
    var int17 = 20;
    var int18 = 0;
    int3 = (int3 + 1);
                    ...
                    while ((int7 < int8)) {
                        ...
                        if ((STRING_LENGTH(string1) > 0)) {
                            ...
                            if ((((STRING_INDEXOF_STRING(string1, string0, 0) > -1) || (STRING_INDEXOF_STRING(string2, string0, 0) > -1)) || (STRING_INDEXOF_STRING(string5, string0, 0) > -1))) {
                                ...
                                if (((script16146(int11, int13) == 1) && (CC_FINDBYCATEGORY[1](comp(365, 19), int14, int7) == 0))) {  // settings:set_click
                                    if ((int12 == 0)) {
                                        string6 = `${string3}<col=ffffff> > </col>${string4}`;
                                        int16 = script20478(string6, int15, 2195, 0);
                                        script2995(23920657, int14, 0, int17, 0, 0, int15, int16, 0, 0, 2195, string6);
                                        CC_SETOP(10, `Go to ${string6}`);
                                        int17 = (int17 + (int16 + 5));
                                        int12 = 1;
                                    };
                                    int17 = script18933(23920658, 23920659, 23920660, int11, int14, int7, int18, int17, int15, int13);
                                    int18 = (int18 + 1);
                                };
                            };
                        };
    ...
    script2681(23920658, int15, 18, 0, 0, 28, `Displaying ${inttostring(int18, 10)} ${script4583(int18, "result", "results")} containing '${string0}'.`, 0);
