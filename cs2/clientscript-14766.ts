//
function script14766(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number): number {
    ...
    if ((int11 == 2)) {
        ...
        script152(int1, (26 + (3 * 8)), int12, ((((int3 + int5) - 26) - (4 * 8)) - int7), (int9 + int10), 26, `${inttostring(script14504(int2), 10)}/${inttostring(DB_GETFIELDCOUNT(int2, 344272), 10)}`, 16777215);
        CC_SETTEXTALIGN(2, 0, 0);
    };
    script10410(int0, -1, 2830, int3, int9, int5, int12, -1, 0, "");
    int9 = (int9 + int12);
    return int9;
}