...
function script9177(int0: number, int1: number, int2: number): number {
    ...
    while ((int3 < int4)) {
        ...
        if (((int1 == 0) || (script9178(struct_getparam(int16, 1268)) == 1))) {
            if (((struct_getparam(int16, 3812) == 0) || (script3224(struct_getparam(int16, 1268)) == 1))) {
    ...
    while ((int13 < int7)) {
        ...
        int12 = int13;
        while ((int12 > 0)) {
            if ((int15 < struct_getparam(enum_getvalue(0, 73, int0, (1 + push_array((int12 - 1)))), 3632))) {
    ...
    while ((int13 < int8)) {
        ...
        int12 = int13;
        while ((int12 > 0)) {
            if ((int15 > push_array[4](push_array[1]((int12 - 1))))) {
    ...
    while ((int13 < int9)) {
        ...
        int12 = int13;
        while ((int12 > 0)) {
            if ((int15 < struct_getparam(enum_getvalue(0, 73, int0, (1 + push_array[2]((int12 - 1)))), 3632))) {
