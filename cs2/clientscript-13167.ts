//
function script13167(int0: number): [number, string, string] {
    var int1 = -1;
    ...
    switch (int0) {
        ...
        case 2: {
            int2 = enum_getvalue(0, 73, 12225, varbitclient_35135);
            string0 = enum_getvalue(0, 36, 5971, varbitclient_35135);
