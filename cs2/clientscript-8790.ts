//
function script8790(int0: number, int1: number, string0: string): number {
    var int2 = 590;
    var int3 = 60;
    var int4 = 0;
    var int5 = 0;
