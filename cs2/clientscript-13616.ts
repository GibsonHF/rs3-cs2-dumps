...
function script13616(int0: number, string0: string): string {
    ...
    if ((((strcmp(struct_getparam(int0, 1274), "") != 0) || (strcmp(struct_getparam(int0, 8082), "") != 0)) && ((strcmp(struct_getparam(int0, 1275), "") != 0) || (strcmp(struct_getparam(int0, 8083), "") != 0)))) {
        ...
        if (((strcmp(struct_getparam(int0, 8082), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8083), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8084), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8085), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8086), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8087), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8088), "") != 0) && (int1 == 1))) {
        ...
        if (((strcmp(struct_getparam(int0, 8089), "") != 0) && (int1 == 1))) {
    ...
    if (((strcmp(struct_getparam(int0, 8081), "") != 0) && (int1 == 1))) {
        if ((strcmp(string0, "") != 0)) {
