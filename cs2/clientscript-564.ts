...
function script564(int0: number): void {
    switch (int0) {
        ...
        case 95682565: {
            if (((script8314(6) != -1) || (((varbitplayer_27170 == 2) && (script8314(5) != -1)) || (script6431() == 1)))) {
                script8426(95682565, 95682566, 95682567, 95682561, 95682562, 95682564, 95682560, 1, varbitplayer_18787);
            };
            break;
        }
        case 95158279: {
            if (((script8314(7) != -1) || (((varbitplayer_27170 == 2) && (script8314(5) != -1)) || (script6431() == 1)))) {
