...
function script16677(): void {
    ...
    script7920(82116645, 3, 2, 3, 1, 0, -30, 1, 1, 294, 294, 0, 0, 19732);
    ...
    script7920(82116645, 3, 5, 0, 3, 0, -17, 1, 1, 75, 75, 0, 0, -1);
    ...
    script10507(82116645, 3, 6, 0, 3, 0, 70, 1, 2, 50, 32, 1, 0, 4699, script16655());
    script7863(82116645, 3, 7, 0, 3, 0, 30, 1, 2, 130, 32, 0, 0, 17062, "Claim");
