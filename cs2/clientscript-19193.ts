...
function script19193(): void {
    ...
    while ((int6 < int7)) {
        ...
        script10507(int9, (int6 + 1), int10, 0, int6, 5, 16, 0, 0, 45, 16, 1, 1, 13569, `<col=FFFFFF>${string1}</col>`);
        int10 = (int10 + 1);
        ...
        int10 = (int10 + 1);
        if ((int5 == 1)) {
            script7920(int9, (int6 + 1), int10, 0, int6, 4, 0, 2, 1, 32, 32, 0, 0, 17057);
            int10 = (int10 + 1);
        };
        int6 = (int6 + 1);
    };
