//
function script8411(int0: number, int1: number): void {
    script12610();
    ...
    var int37 = 1;
    var int38 = 0;
    if (((struct_getparam(int2, 3734) == 0) || (((int0 == 1000) && (IF_HASSUBOVERLAY(96796703, 1421) == 1)) || ((int0 == 1004) && (varbitplayer_60446 == 1))))) {
        int37 = 0;
    ...
    if ((int7 != comp(-1, 65535))) {
        ...
        if ((struct_getparam(int3, 8094) == 1)) {
            ...
            if (((varbitplayer_38842 == 0) || (struct_getparam(int2, 8659) == 0))) {
                ...
                script2996(int7, 16, struct_getparam(int3, 8295), int27, 2, 0, 16, 32, 1, 0, 4127);
                CC_SENDTOBACK();
                if ((struct_getparam(int2, 8659) == 1)) {
                    ...
                    script2994(int7, 17, (struct_getparam(int3, 8295) + 4), (int27 + 4), 2, 0, 24, 24, 0, 0, 8122);
                    if ((int1 == 0)) {
                        script12591(0, int2);
                    };
                } else {
    ...
    if ((int9 != comp(-1, 65535))) {
        CC_DELETEALL(int9);
        if ((struct_getparam(int3, 8094) == 1)) {
            if ((((((((int32 == 1) || (int36 == 1)) && (int20 == 1)) && (int0 != 1001)) && (int0 != 1008)) && (int0 != 17)) && (enum_getreversecount(0, 7717, int0) != 0))) {
                IF_SETHIDE(1, int9);
            } else {
