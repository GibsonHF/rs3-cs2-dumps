//
function script14442(int0: number, int1: number, int2: number, int3: number, int4: number): void {
    CC_DELETEALL(int2);
    ...
    var int5 = script15073(int4, 16365, -1);
    var int6 = script5276(script15073(int4, 16365, -1), 2);
