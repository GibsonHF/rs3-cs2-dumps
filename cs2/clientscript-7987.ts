//
function script7987(int0: number): void {
    ...
    var int2 = -1;
    var int3 = 0;
    if ((enum_getreversecount(9, 10364, int0) == 1)) {
        int2 = enum_getreverseindex(9, 0, 10364, int0, 0);
        int3 = (IF_GETY(int0) + IF_GETHEIGHT(int0));
        while ((++int2 < ENUM_GETOUTPUTCOUNT(10364))) {
