...
function script19408(int0: number, int1: number, int2: number, int3: number, int4: number): number {
    ...
    stack(int5);
    int5 = (int5 + 1);
    script15938(0, int2, 0, 0, 0, 36, 1, 0);
    ...
    stack(int5);
    int5 = (int5 + 1);
    script10033(0, 0, 0, 0, 0, 0, 1, 1, int15);
    script12591(8, 50665);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script15937(0, 0, 1, 1, (4 * 2), (4 * 2), 1, 1);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script7918(0, 0, 0, 1, 20, 20, 0, 0, int14);
    script3537(string4);
    CC_GETDYNAMICLAYER();
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script15937(0, 0, 2, 1, 22, 0, 1, 1);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script10485(0, 0, 0, 0, int11, 8192, 1, 2, 2100, string0);
    CC_SETMAXLINES(1);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script7918(0, 0, 0, 2, int8, 12, 0, 0, int13);
    script3537(string2);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script10485(0, 0, 2, 2, int9, int17, 1, int18, 2100, string3);
    CC_SETCOLOUR(int10);
    CC_SETMAXLINES(1);
    script3537(string2);
    stack(int1);
    stack(int5);
    int5 = (int5 + 1);
    script7918(0, 0, 2, 1, int11, int11, 0, 0, int12);
    script3537(string1);
    return ((int2 + 36) + 4);
}