...
function script3650(int0: number, int1: number, int2: number): void {
    ...
    if ((STRING_LENGTH(string1) > 0)) {
        ...
        if ((int22 != -1)) {
            script8758(int1, int16, enum_getvalue(17, 36, 680, int22), int24);
        } else {
    ...
    int16 = (int16 + 34);
    while ((int17 < int12)) {
        [int6, int5, int7, int8, int9, int10, int11, string0] = dbrow_getfield(int3, 303344, int17);
        if ((int21 == 1)) {
            if ((int17 != int19)) {
                if (((int11 == 1) && (AND(int5, varplayer_9062) != 0))) {
                    if (((STRING_LENGTH(string0) == 0) && (int8 != -1))) {
