...
function script16267(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number): number {
    ...
    if (((((int8 != -1 as obj) && (item_getparam(int8, 2640) > 0)) && (item_getparam(int8, 2640) != 62)) && (item_getparam(int8, 2641) == 0))) {
        if (((item_getparam(int8, 2640) == int7) || (int7 == -1))) {
    ...
    int13 = ((STRINGWIDTH(string0, 23 as fontmetrics) / 2) + 20);
    if ((RANDOM(2) == 0)) {
