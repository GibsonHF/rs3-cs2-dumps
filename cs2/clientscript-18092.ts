...
function script18092(int0: number, int1: number, int2: number, int3: number): [number, number] {
    ...
    while ((int1 <= int5)) {
        ...
        if ((CC_FINDBYCATEGORY(int4, 1, int0) == 1)) {
            ...
            var int2 = (int2 + 1);
            if ((db_find_with_count(1032193, int7, 0) > 0)) {
                if ((int3 != int1)) {
                    int8 = 1;
                } else {
                    int8 = 0;
