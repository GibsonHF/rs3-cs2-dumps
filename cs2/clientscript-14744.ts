...
function script14744(): void {
    ...
    CC_SETTEXTALIGN(0, 0, enum_getvalue(25, 0, 8549, int10));
    int11 = (int11 + (int12 + (2 * 2)));
    if (((MAP_MEMBERS() == 0) && (int3 == 1))) {
        stack(int0);
        stack(int11);
        int8 = (int8 + 1);
        int11 = script14754(int8);
    };
    if ((STRING_LENGTH(string2) > 0)) {
        stack(int0);
        stack(int11);
        int8 = (int8 + 1);
        int11 = script14753(int8, string1, string2);
    };
    stack(int0);
    stack(int11);
    int8 = (int8 + 1);
    int11 = script14753(int8, "Archaeology Level", inttostring(dbrow_getfield(int2, 352352, 0), 10));
    if ((int5 != -1)) {
        stack(int0);
        stack(int11);
        int8 = (int8 + 1);
        int11 = script14753(int8, "Qualification", dbrow_getfield(int5, 380944, 0));
    };
    if ((int6 != -1)) {
        stack(int0);
        stack(int11);
        int8 = (int8 + 1);
        int11 = script14753(int8, "Soil", OC_NAME(int6));
    };
