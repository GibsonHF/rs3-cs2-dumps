//
function script12234(int0: number): void {
    ...
    var int5 = script6431();
    if ((int1 < 108)) {
        IF_SETHIDE(1, struct_getparam(int0, 8141));
        IF_SETHIDE(1, struct_getparam(int0, 8142));
        IF_SETHIDE(0, struct_getparam(int0, 8153));
        ...
        IF_SETHIDE(1, struct_getparam(int0, 8141));
        IF_SETHIDE(1, struct_getparam(int0, 8142));
        IF_SETHIDE(1, struct_getparam(int0, 8153));
    };
    return;
}