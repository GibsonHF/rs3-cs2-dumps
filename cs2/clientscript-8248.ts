//
function script8248(int0: number, int1: number): number {
    switch (int0) {
        case 8: {
            break;
        }
        ...
        case 3: {
            switch (int1) {
                case 5: {
                    if (((script4356() == 1) && (script15411(45048) == 1))) {
                        return 1;
                    };
                    return 0;
                }
                case 10: {
                    if (((script4356() == 1) && (script15411(46276) == 1))) {
                        return 1;
                    };
                    return 0;
                }
        ...
        case 4: {
            switch (int1) {
                ...
                case 1: {
                    if (((script4356() == 1) && (script15411(44900) == 1))) {
                        return 1;
                    };
                    return 0;
                }
                ...
                case 4: {
                    if (((script4356() == 1) && (script15411(45046) == 1))) {
                        return 1;
                    };
                    return 0;
                }
                case 164: {
                    if (((script4356() == 1) && (script15411(46275) == 1))) {
                        return 1;
                    };
                    return 0;
                }
