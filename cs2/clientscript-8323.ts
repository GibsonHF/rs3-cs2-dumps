//
function script8323(int0: number, int1: number): void {
    ...
    switch (int2) {
        ...
        default: {
            if ((varbitplayer_38842 == 1)) {
                ...
                IF_SETHIDE(1, struct_getparam(script10405(int0), 3503));
                if (((int0 == 2) && (IF_GETHIDE(18087954) == 0))) {
                    IF_SETHIDE(1, comp(276, 18));
                };
                script2638();
                script10228();
