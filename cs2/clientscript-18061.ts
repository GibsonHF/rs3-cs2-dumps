//
function script18061(int0: number, int1: number, int2: number): void {
    var int3 = 0;
    ...
    if ((CC_FINDBYCATEGORY(int0, (2 + 40), 0) == 1)) {
        ...
        script15937(int4, int3, 0, int5, 0, 0, 0, 0, 1, 1);
        int3 = (int3 + 1);
        script7918(int4, int3, 90, 5, 0, 0, 60, 60, 0, 0, 4465);
        int3 = (int3 + 1);
        script10485(int4, int3, 160, 20, 0, 0, 0, 30, 1, 0, 7982, `New Random General Mission in: ${script18087(script18062(), 1, 0)}`);
        int3 = (int3 + 1);
        script7862(0, int4, 8, 0, 0, 0, (IF_GETWIDTH(int0) - 16), 70, 0, 0, script17989(2), "", 0, 1, 0, 0);
    };
    return;
