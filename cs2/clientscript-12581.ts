//
function script12581(int0: number, int1: number, int2: number, int3: number): void {
    ...
    if ((varbitclient_32659 > 0)) {
        ...
        if ((int7 < 1)) {
            IF_SETHIDE(true, comp(1771, 86));  // gwd2_solo_loot:difficulty_continue_button_disabled_layer
    ...
    while ((CC_FIND(int1, int6) == 1)) {
        if ((CC_FIND[1](int0, int6) == 1)) {
            ...
            if ((int5 > int4)) {
                int5 = ((-150 + int5) - int4);
                if ((varbitplayer_32636 != 0)) {
                    if ((varbitclient_32660 == 0)) {
                        if ((int6 != 1)) {
