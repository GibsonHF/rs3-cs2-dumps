//
function script1488(int0: number, int1: number, int2: number, int3: number): void {
    CC_DELETEALL(int0);
    var int4 = 66;
    var int5 = 96;
    ...
    if ((int6 < 10)) {
        ...
        CC_SETGRAPHIC(script1489((int6 / 10)));
        CC_CREATE(int0, 5, 1);
        CC_SETSIZE(int4, int5, 0, 0);
        CC_SETPOSITION(0, 0, 1, 1);
        CC_SETGRAPHIC(script1489(MODULO(int6, 10)));
    };
    IF_SETONTIMER(callback(script1488, int0, int1, int6, int3), 47382539);
    return;
}