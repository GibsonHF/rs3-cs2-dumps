//
function script11017(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number): void {
    ...
    int10 = (int10 + 3);
    [int10, int12] = script10429(int1, int0, 0, int10, int11, int12, 7230, -1, "Select types of world.", varbitplayer_26925, 0);
    int10 = (int10 + 10);
    [int10, int14] = script6310(int1, "Toggle lootshare worlds.", int10, 0);
    int10 = (int10 + 3);
    [int10, int12] = script10429(int1, int0, 0, int10, int11, int12, 9728, -1, "Select loot settings.", varbitplayer_26926, 0);
    int10 = (int10 + 15);
