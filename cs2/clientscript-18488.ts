//
function script18488(int0: number, int1: number, int2: number, int3: number, int4: number): void {
    var int5 = 0;
    var int6 = 5;
    var int7 = 0;
    var int8 = 3;
    var string0 = "No content exclusively obtained via Treasure Hunter is essential to play RuneScape.";
    int5 = script15891(string0, IF_GETWIDTH(int4), 206, 0);
    script2995(int4, int7, 0, int6, 0, 0, 0, int5, 1, 0, 2101, string0);
    int6 = (int6 + (int5 + int8));
    int7 = (int7 + 1);
    ...
    int5 = script15891(string1, IF_GETWIDTH(int4), 206, 0);
    script2995(int4, int7, 0, int6, 0, 0, 0, int5, 1, 0, 2101, string1);
    int6 = (int6 + (int5 + int8));
    int7 = (int7 + 1);
    var string2 = "Some items from Treasure Hunter are not useable on non-members worlds.";
    int5 = script15891(string2, IF_GETWIDTH(int4), 206, 0);
    script2995(int4, int7, 0, int6, 0, 0, 0, int5, 1, 0, 2101, string2);
    int6 = (int6 + (int5 + int8));
    int7 = (int7 + 1);
    if ((MAP_MEMBERS() == 0)) {
    ...
    var string3 = "";
    var int9 = 0;
    if ((int2 == comp(1253, 473))) {  // wheel_of_fortune:probabilities_data_layer
        int9 = 452;
    } else {
        int9 = 395;
    };
    if ((struct_getparam(int3, 9072) == true)) {
        ...
        int5 = script15891(string3, IF_GETWIDTH(int4), 206, 0);
        script2995(int4, int7, 0, int6, 0, 0, 0, int5, 1, 0, 2101, string3);
        int6 = (int6 + (int5 + int8));
    };
