//
function script322(int0: number, int1: number, int2: number, int3: number, int4: number, string0: string, string1: string, string2: string, string3: string, string4: string, string5: string): void {
    CC_DELETEALL(int0);
    var int5 = 0;
    var int6 = 0;
    var int7 = 0;
