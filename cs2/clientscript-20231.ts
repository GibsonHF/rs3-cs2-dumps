...
function script20231(): void {
    ...
    if (((varbitplayer_58385 == 2) || (varbitplayer_58385 == 4))) {
        ...
        if ((varbitplayer_58380 == 0)) {
            [int1, int2] = script19615(0, int1, int2, int0, `Rewards may only be imported by '<col=FFFFFF>${varclient_8331}</col>'.`);
            CC_SETTEXTALIGN(1, 1, 0);
        } else {
            [int1, int2] = script19615(0, int1, int2, int0, " ");
        };
    } else if ((STRING_INDEXOF_STRING(CHAT_PLAYERNAME(), "#", 0) == -1)) {
        [int1, int2] = script19615(0, int1, int2, int0, "Rewards may only be imported by 'this character'.");
        CC_SETTEXTALIGN(1, 1, 0);
    } else {
        [int1, int2] = script19615(0, int1, int2, int0, `Rewards may only be imported by '<col=FFFFFF>${CHAT_PLAYERNAME()}</col>'.`);
        CC_SETTEXTALIGN(1, 1, 0);
    };
