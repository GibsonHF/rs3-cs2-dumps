//
function script10611(int0: number): [number, string, string] {
    ...
    if ((struct_getparam(int0, 1345) > 0)) {
        int2 = enum_getvalue(0, 3, 2252, struct_getparam(int0, 1345));
        string0 = script2103(int2);
        string1 = quest_getparam(int2, 5968);
    };
    switch (MAP_LANG()) {
        case 1: {
            if ((struct_getparam(int0, 4450) != -1)) {
                int1 = struct_getparam(int0, 4450);
            };
            break;
        }
        case 2: {
            if ((struct_getparam(int0, 4451) != -1)) {
                int1 = struct_getparam(int0, 4451);
            };
            break;
        }
        case 3: {
            if ((struct_getparam(int0, 4452) != -1)) {
                int1 = struct_getparam(int0, 4452);
            };
            break;
        }
        case 6: {
            if ((struct_getparam(int0, 4453) != -1)) {
