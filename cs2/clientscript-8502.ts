...
function script8502(int0: number, int1: number, int2: number): void {
    ...
    while ((int4 <= int2)) {
        if ((int5 != -1)) {
            if ((int6 == 100)) {
                if (((((int5 == 125) || (int5 == 137)) || (int5 == 138)) || (int5 == 139))) {
                    varclient_5882 = 1;
                    script15210(4);
                };
            };
            if ((script8507(int0, int5, 0, int9) == 1)) {
                if ((script8508(int0, int5, int6, string2, int8, int9) == 1)) {
                    int10 = (int10 + 1);
    ...
    while ((int11 >= int10)) {
        if (((CC_FIND[1](int3, int11) == 1) && (CC_FIND(int3, (int11 - int10)) == 1))) {
            ...
            [int5, string0, int6, string1, string2, string3, string4, int7, string5, int8, int9] = unk11059(cc_getparam(3443));
