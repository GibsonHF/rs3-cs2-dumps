...
function script1842(int0: number, int1: number, int2: number): void {
    ...
    while ((int6 < int2)) {
        ...
        if ((strcmp(LOWERCASE(struct_getparam(int8, 596)), LOWERCASE(struct_getparam(int9, 596))) < AND(int6, 1))) {
    ...
    pop_array(int5, int4);
    if ((int1 < (int5 - 1))) {
        script1842(0, int1, (int5 - 1));
    };
    if (((int5 + 1) < int2)) {
        script1842(0, (int5 + 1), int2);
    };
    return;
}