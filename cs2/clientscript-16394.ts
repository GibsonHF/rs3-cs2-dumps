...
function script16394(): void {
    ...
    if ((dbrow_getfield(varplayer_8745, 291024, 0) == 1)) {
        int7 = script16380(varplayer_8745);
        int8 = script16382(varplayer_8745, varplayer_8747);
    };
    [string2, int0] = dbrow_getfield(varplayer_8746, 294992, 0);
    ...
    if (((int2 != -1) || (int1 != -1))) {
        ...
        if ((int3 != -1)) {
            [int20, int21] = script16415(int3, -1);
            if ((int4 != -1)) {
                int17 = 3;
                [int22, int23] = script16415(int4, -1);
    ...
    while ((int33 < int32)) {
        int30 = enum_getvalue(0, 25, 8488, int33);
    ...
    var int38 = 0;
    while ((int33 < int32)) {
        int34 = enum_getvalue(0, 25, 8488, int33);
