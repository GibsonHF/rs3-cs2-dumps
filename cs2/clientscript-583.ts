//
function script583(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number, int10: number): void {
    script10410(int2, -1, int5, int6, int7, int8, int9, int10, 0, "");
    script10410(int2, -1, 28575, (int6 + 5), (int7 + 35), 40, 40, 0, 0, "");
    var int11 = 0;
    ...
    if ((int12 == 0)) {
        script13980(int2, int4, 28553, (int6 + 5), (int7 + 81), 103, int10, 0, string0);
    } else {
        script13980(int2, int4, 28554, (int6 + 5), (int7 + 81), 103, int10, 0, string0);
    };
