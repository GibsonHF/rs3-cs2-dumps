//
function script8771(int0: number): void {
    if ((int0 == 1)) {
        script8844(1, 96, 0, 96796713, -1);
        script8844(2, 97, 0, 96796713, -1);
        script8844(3, 98, 0, 96796713, -1);
        script8844(4, 99, 0, 96796713, -1);
        script8844(9, 104, 0, 96796713, -1);
        script8844(10, 105, 0, 96796713, -1);
        IF_SETOPKEYRATE(1, 1, 1, 96796713);
        IF_SETOPKEYRATE(2, 1, 1, 96796713);
        IF_SETOPKEYRATE(3, 1, 1, 96796713);
        IF_SETOPKEYRATE(4, 1, 1, 96796713);
