//
function script1994(int0: number, int1: number, int2: number, int3: number): void {
    CC_DELETEALL(int0);
    var int4 = 66;
    var int5 = 96;
    ...
    IF_SETONTIMER(callback(script1994, int0, int1, int6, int3), comp(1040, 2));  // town_ingame_hud:countdown_layer
    return;
}