...
function script3678(int0: number, int1: number, int2: number, int3: number): void {
    CC_DELETEALL(int0);
    CC_DELETEALL(int1);
    CC_DELETEALL(int2);
    CC_DELETEALL(int3);
    ...
    while ((int4 < 30)) {
        ...
        if ((MODULO(int4, 2) == 0)) {
            ...
            if ((script9555(item_getparam(enum_getvalue(0, 33, 3272, int13), 25)) == 1)) {
        ...
        CC_SETOPBASE(`<col=FF981F>${enum_getvalue(0, 36, 3274, int13)} piece`);
