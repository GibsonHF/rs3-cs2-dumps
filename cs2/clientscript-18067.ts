//
function script18067(int0: number, int1: number, int2: number): [number, number, number] {
    ...
    if ((CC_FINDBYCATEGORY(int1, (int23 + 40), 0) == 1)) {
        ...
        int13 = (int13 + 1);
        script10485(int0, int13, 110, 0, 0, 0, 0, 30, 1, 0, 7982, dbrow_getfield(int3, 1019904, 0));
        int13 = (int13 + 1);
        script10485(int0, int13, 110, 16, 0, 0, 0, 30, 1, 0, 7998, script18073(int3));
        int13 = (int13 + 1);
        script10485(int0, int13, ((IF_GETWIDTH(int1) / 2) - 60), 60, 0, 0, (IF_GETWIDTH(int1) / 3), 30, 0, 0, 7982, "Rewards:");
        int13 = (int13 + 1);
        int9 = (int9 + 25);
