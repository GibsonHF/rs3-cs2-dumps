//
function script16618(int0: number): void {
    var int1 = 0;
    script14391(82116611, 3, 8, 93, 2, 1, 296, 121, 0, 0);
    stack(82116611);
    stack(4);
    stack(int1);
    int1 = (int1 + 1);
    script7920(0, 3, 0, 0, 1, 1, 0, 0, 1, 1, 19519);
    ...
    stack(int1);
    int1 = (int1 + 1);
    script7920(0, 3, -96, -5, 1, 1, 91, 1, 0, 4, dbrow_getfield(int0, 749632, 0));
    ...
    stack(int1);
    int1 = (int1 + 1);
    script10507(0, 3, 10, 15, 2, 0, 176, 40, 0, 0, 1314, dbrow_getfield(int0, 749584, 0));
    ...
    stack(int1);
    int1 = (int1 + 1);
    script10507(0, 3, 10, 20, 2, 2, 176, 30, 0, 0, 1314, string0);
    ...
    stack(int1);
    int1 = (int1 + 1);
    script10507(0, 3, -96, 20, 1, 2, 91, 30, 0, 0, 1314, "Next");
