//
function script11930(int0: number): void {
    ...
    while ((int5 < int1)) {
        if ((enum_getvalue(0, 22, 10579 as cs2enum, int5) != -1 as coordgrid)) {
            ...
            string1 = `Requires level ${inttostring(enum_getvalue(0, 0, 16061, int5), 10)} Archaeology.`;
            ...
            if ((int3 != -1)) {
                if ((int4 != -1)) {
                    ...
                    if ((int7 == 0)) {
                        ...
                        int8 = PARAWIDTH(enum_getvalue(0, 36, 13251, int5), 94 as fontmetrics, 26);
                        IF_SETHIDE(false, enum_getvalue(0, 9, 10580, int5));
                        IF_SETPOSITION((int3 + 25), (int4 + 19), 0, 0, enum_getvalue(0, 9, 10580, int5));
                        IF_SETTEXT(enum_getvalue(0, 36, 13251, int5), enum_getvalue(0, 9, 10581, int5));
                        IF_SETSIZE((int8 + 14), 17, 0, 0, enum_getvalue(0, 9, 10580, int5));
                        int6 = 1;
                    };
                    if ((MAP_MEMBERS() == 0)) {
                        int2 = 11973;
