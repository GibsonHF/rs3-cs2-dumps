//
function script16889(int0: number, int1: number, int2: number, int3: number, int4: number): void {
    var int5 = ENUM_GETOUTPUTCOUNT(14157);
    ...
    while ((int6 < int7)) {
        ...
        script7918(int6, 1, 0, 0, 1, 1, 0, 0, 1, 1, 10804);
