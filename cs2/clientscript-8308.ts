//
function script8308(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number): void {
    var int9 = script10405(int0);
    if (((int9 == -1) || (struct_getparam(int9, 3519) == false))) {
        return;
    };
    var int10 = 0;
    var int11 = -1;
    ...
    while ((int12 < int13)) {
        ...
        if (((int11 != -1) && (struct_getparam(int11, 3520) == int0))) {
