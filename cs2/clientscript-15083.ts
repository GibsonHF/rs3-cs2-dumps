...
function script15083(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number, int10: number, int11: number, int12: number, int13: number, string0: string, string1: string, string2: string, string3: string): void {
    ...
    stack(int21);
    int21 = (int21 + 1);
    script15938(int1, int2, 0, 0, int3, int4, 0, 0);
    CC_SETOP(1, string0);
    CC_SETOPCURSOR(1, 46);
    switch (int5) {
        case 1: {
    ...
    stack(int21);
    int21 = (int21 + 1);
    script7918(0, 0, 0, 0, 0, 0, 1, 1, int16);
    stack(int6);
    stack(int21);
    int21 = (int21 + 1);
    script7918(0, 0, 0, 0, 0, 0, 1, 1, int7);
    stack(int6);
    stack(int21);
    int21 = (int21 + 1);
    script7918(0, 0, 0, 0, 0, 0, 1, 1, int14);
    stack(int6);
    stack(int21);
    int21 = (int21 + 1);
    script7918(int19, int20, 1, 2, int17, int18, 0, 0, int15);
    if ((STRING_LENGTH(string2) > 0)) {
        ...
        stack(int21);
        int21 = (int21 + 1);
        script10485(15, 40, 0, 2, 30, int23, 1, 0, 4699, string2);
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script10485(10, (45 + int23), 0, 2, 20, int24, 1, 0, int26, string1);
    } else {
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script10485(10, 40, 0, 2, 20, int27, 1, 0, int26, string1);
    };
    if ((STRING_LENGTH(string3) > 0)) {
        ...
        stack(int21);
        int21 = (int21 + 1);
        script15938((((int1 + 255) - int22) + 22), int25, 0, 0, int22, 64, 0, 0);
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script7918(0, 0, 2, 0, 32, 0, 0, 1, struct_getparam(int8, 4740));
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script7918(0, 0, 0, 0, 78, 0, 0, 1, struct_getparam(int8, 4738));
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script7918(78, 0, 0, 0, (78 + 32), 0, 1, 1, struct_getparam(int8, 4739));
        stack(int6);
        stack(int21);
        int21 = (int21 + 1);
        script10485(20, 3, 2, 0, 60, 43, 1, 0, 4700, string3);
    };
    var int30 = 0;
    var int31 = 0;
    var string4 = "";
    if ((int11 >= 0)) {
        ...
        if ((int10 == 1)) {
            ...
            stack(int21);
            int21 = (int21 + 1);
            script20483(int6, 0, 0, 60, 1, 2, (255 - 80), 25, 0, 0, 17466, string4, -1, 1, 1);
        } else if ((int13 == 0)) {
            stack(int0);
            stack(int6);
            stack(int21);
            int21 = (int21 + 1);
            script7920(int6, 0, (int31 - 14), 6, 1, 2, 25, 25, 0, 0, 14158);
            stack(int0);
            stack(int6);
            stack(int21);
            int21 = (int21 + 1);
            script10507(int6, 0, ((255 / 2) + int31), 8, 0, 2, (255 / 2), 25, 0, 0, 17466, string4);
        } else if ((int11 > 0)) {
            stack(int0);
            stack(int6);
            stack(int21);
            int21 = (int21 + 1);
            script7920(int6, 0, (int31 - 16), 6, 1, 2, 30, 30, 0, 0, 22168);
            stack(int0);
            stack(int6);
            stack(int21);
            int21 = (int21 + 1);
            script10507(int6, 0, ((255 / 2) + int31), 10, 0, 2, (255 / 2), 25, 0, 0, 17466, string4);
        };
    } else {
        ...
        if ((STRING_LENGTH(string4) > 0)) {
            ...
            stack(int21);
            int21 = (int21 + 1);
            script20483(int6, 0, 0, 10, 1, 2, (255 - 80), 25, 0, 0, 17466, string4, -1, 1, 1);
        };
    };
    return;
}