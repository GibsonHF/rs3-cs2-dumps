//
function script9029(int0: number, int1: number, int2: number): string {
    if ((((int0 == -1) && (int1 == -1 as quest)) && (int2 == -1))) {
        return "";
    };
    var string0 = "";
    ...
    if ((int0 != -1)) {
        ...
        if ((struct_getparam(int0, 1345) > 0)) {
            ...
            if (((strcmp(struct_getparam(int0, 1274), "") != 0) || (strcmp(struct_getparam(int0, 8082), "") != 0))) {
                if (((strcmp(struct_getparam(int0, 1275), "") != 0) || (strcmp(struct_getparam(int0, 8083), "") != 0))) {
                    if ((strcmp(string0, "") != 0)) {
                        string0 = strconcat(string0, "<br>");
                    };
                    ...
                    if ((strcmp(struct_getparam(int0, 8083), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8084), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8085), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8086), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8087), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8088), "") != 0)) {
                        if ((int3 == 1)) {
                    ...
                    if ((strcmp(struct_getparam(int0, 8089), "") != 0)) {
                        if ((int3 == 1)) {
            ...
            if ((strcmp(struct_getparam(int0, 8081), "") != 0)) {
                if ((int3 == 1)) {
                    if ((strcmp(string0, "") != 0)) {
