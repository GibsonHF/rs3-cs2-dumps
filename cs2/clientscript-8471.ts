            ...
            if ((CC_FIND(int8, int31) == 1)) {
                if ((script8477(int31, int2) == 0)) {
                    ...
                    if ((int35 != -1 as obj)) {
                        ...
                        switch (int8) {
                            case 33882140: {
                                if (((((((((((item_getparam(int35, 2091) == false) || (strcmp(item_getparam(int35, 528), "Remove") == 0)) || (strcmp(item_getparam(int35, 529), "Remove") == 0)) || (strcmp(item_getparam(int35, 530), "Remove") == 0)) || (strcmp(item_getparam(int35, 531), "Remove") == 0)) || (strcmp(item_getparam(int35, 1211), "Remove") == 0)) || (strcmp(item_getparam(int35, 6712), "Remove") == 0)) || (strcmp(item_getparam(int35, 6713), "Remove") == 0)) || (strcmp(item_getparam(int35, 6714), "Remove") == 0)) || (item_getparam(int35, 9058) == 1))) {
                        ...
                        if ((int16 == 1)) {
                            if (((CC_GETLAYER() == 95813663) || (CC_GETLAYER() == 95944719))) {
                    ...
                    if ((int1 != -1)) {
                        if ((int1 == 818)) {
                            if ((script13139(int1, int31) == 0)) {
                                ...
                                if (((enum_getvalue(0, 33, 8043, int31) != -1) && (int37 != enum_getvalue(0, 33, 8043, int31)))) {
                                    CC_SETOP(4, "Hide slot");
                                };
                                CC_SETTRANS(127);
                                if ((int37 == -1)) {
                                    script14994(-1, -1, -1, 39753, int1, 0);
                                } else {
                                ...
                                switch (int31) {
                                    ...
                                    case 14: {
                                        if ((int37 != -1)) {
                                            ...
                                            if ((((int38 != -1) && (item_getparam(int37, 2500) != -1)) && (item_getparam(int37, 2500) != 28387))) {
                                                if ((int16 == 1)) {
                                                    CC_SETOP(5, "Recolour");
                                                } else {
                                        ...
                                        if (((int37 != INV_GETOBJ(817 as inv, int31)) || (script13103(int1, int31) != script13103(817, int31)))) {
                                            if ((int16 == 1)) {
                                            ...
                                            } else if ((int37 == INV_GETOBJ(817 as inv, int31))) {
                                                if ((script12779(int38, int37, script13103(int1, int31)) == 1)) {
                                                    if ((CC_FIND[1](int7, int31) == 1)) {
                                                        CC_CREATE(int11, 5, IF_GETNEXTSUBID(int11));
                                                        CC_SETSIZE(CC_GETWIDTH[1](), CC_GETHEIGHT[1](), 0, 0);
                                                        CC_SETPOSITION(CC_GETX[1](), CC_GETY[1](), 0, 0);
                                    ...
                                    case 10: {
                                        if ((int37 == 39752)) {
                                            ...
                                            CC_SETOP(3, "Clear customisation");
                                            if ((int38 != -1)) {
                                                if ((item_getparam(int37, 2500) != -1)) {
                                                    if ((item_getparam(int37, 2500) != 28387)) {
                                                        if ((int16 == 1)) {
                                                            CC_SETOP(5, "Recolour");
                                                        } else {
                                                            CC_SETOP(5, "Recolour (SHIFT+Click)");
                                        ...
                                        } else if (((int37 != -1) && (TESTBIT(varplayer_6870, int31) == 1))) {
                                            CC_SETGRAPHIC(script8478(int1, int31, 1));
                                            CC_SETTRANS(0);
                                            CC_SETOP(3, "Clear customisation");
                                            if ((int38 != -1)) {
                                        ...
                                        if ((((int37 != INV_GETOBJ(817 as inv, int31)) || (TESTBIT(varplayer_6870, int31) != TESTBIT(varplayer_6869, int31))) || (script13103(int1, int31) != script13103(817, int31)))) {
                                            if ((int16 == 1)) {
                                                CC_SETOP(2, "Undo change");
                                            } else {
                                                CC_SETOP(2, "Undo change (CTRL+Click)");
                                            ...
                                            } else if ((script12779(int38, int37, script13103(int1, int31)) == 1)) {
                                                if (((int37 == int35) || (script13428(int35, int37) == 1))) {
                                                    if ((TESTBIT(varplayer_6870, int31) == 0)) {
                                                        if ((CC_FIND[1](int7, int31) == 1)) {
                                                            CC_CREATE(int11, 5, IF_GETNEXTSUBID(int11));
                                                            CC_SETSIZE(CC_GETWIDTH[1](), CC_GETHEIGHT[1](), 0, 0);
                                                            CC_SETPOSITION(CC_GETX[1](), CC_GETY[1](), 0, 0);
                                                        ...
                                                        if ((TESTBIT(varplayer_6870, int31) == TESTBIT(varplayer_6869, int31))) {
                                                            if ((CC_FIND[1](int7, int31) == 1)) {
                                                                CC_CREATE(int11, 5, IF_GETNEXTSUBID(int11));
                                                                CC_SETSIZE(CC_GETWIDTH[1](), CC_GETHEIGHT[1](), 0, 0);
                                                                CC_SETPOSITION(CC_GETX[1](), CC_GETY[1](), 0, 0);
