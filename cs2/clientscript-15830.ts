...
function script15830(): string {
    switch (varplayer_1831) {
        case 28700: {
            return `${enum_getvalue(0, 36, 7541, varbitplayer_18595)}${enum_getvalue(0, 36, 7542, varbitplayer_18596)}${enum_getvalue(0, 36, 7543, varbitplayer_18597)}`;
        }
        case 29438:
        case 29439:
        case 29440: {
            return enum_getvalue(0, 36, 7942, varbitplayer_20386);
        }
        case 23030: {
    ...
    if ((strcmp(string0, "Animal") == 0)) {
        if ((item_getparam(varplayer_1831, 74) != -1)) {
            string0 = enum_getvalue(32, 36, 1279, item_getparam(varplayer_1831, 74));
            if ((strcmp(string0, "Animal") == 0)) {
