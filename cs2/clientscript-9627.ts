//
function script9627(int0: number, int1: number, int2: number): void {
    ...
    while ((int6 < int2)) {
        ...
        if ((struct_getparam(int8, 4031) < struct_getparam(int9, 4031))) {
    ...
    pop_array(int5, int4);
    if ((int1 < (int5 - 1))) {
        script9627(0, int1, (int5 - 1));
    };
    if (((int5 + 1) < int2)) {
        script9627(0, (int5 + 1), int2);
    };
    return;
}