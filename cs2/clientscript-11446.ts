...
function script11446(): void {
    ...
    while ((int7 < int3)) {
        ...
        if ((struct_getparam(int13, 5084) == 0)) {
            script10764(int1, 21361, int9, int10, int11, int12, -1);
            ...
            if ((((struct_getparam(int13, 5084) != 0) && (struct_getparam(int13, 5084) <= varplayer_3079)) && (struct_getparam(int13, 5085) >= varplayer_3079))) {
                ...
                string1 = strconcat(string1, `<br>This item will be in the store until ${inttostring(int19, 10)} ${enum_getvalue(0, 36, 950, int20)} ${inttostring(int21, 10)}`);
            };
            if (((struct_getparam(int13, 5086) == 1) && (script4148() == 1))) {
            ...
            if ((struct_getparam(int13, 5634) == 1)) {
                int18 = script10410(int1, int2, 28556, (int9 + ((int11 - 80) - (5 * 2))), (int10 + ((int12 - 20) - 5)), 80, 20, int18, int22, string0);
        ...
        } else if ((struct_getparam(int13, 5084) <= varplayer_3079)) {
            if (((struct_getparam(int13, 5085) >= varplayer_3079) || (struct_getparam(int13, 5085) == 1))) {
                script10764(int1, 21361, int9, int10, int11, int12, -1);
                CC_CREATE(int1, 3, IF_GETNEXTSUBID(int1));
                CC_SETPOSITION(int9, int10, 0, 0);
                CC_SETSIZE(int11, int12, 0, 0);
