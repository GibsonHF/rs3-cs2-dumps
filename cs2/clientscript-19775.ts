//
function script19775(int0: number): [number, number, number, number, string] {
    ...
    var int2 = struct_getparam(enum_getvalue(0, 73, 869, int0), 939);
    var int3 = struct_getparam(enum_getvalue(0, 73, 869, int0), 937);
    var int4 = 1;
    var int5 = 0;
    if ((struct_getparam(enum_getvalue(0, 73, 869, int0), 940) == 1)) {
        switch (int0) {
            case 0: {
                if ((STAT_BASE(7 as stat) < 40)) {
                    int1 = struct_getparam(enum_getvalue(0, 73, 869, int0), 936);
                    int4 = 0;
                };
                break;
            }
        ...
        if ((int5 == 1)) {
            int1 = struct_getparam(enum_getvalue(0, 73, 869, int0), 942);
            int4 = 1;
            string0 = struct_getparam(enum_getvalue(0, 73, 869, int0), 941);
            int3 = struct_getparam(enum_getvalue(0, 73, 869, int0), 943);
            int2 = struct_getparam(enum_getvalue(0, 73, 869, int0), 944);
        };
    };
