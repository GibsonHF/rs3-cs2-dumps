//
function script6121(int0: number): void {
    var string0 = "";
    switch (int0) {
        case 0: {
    ...
    if ((strcmp(string0, IF_GETTEXT(40697890)) == 0)) {
        return;
    };
    var int1 = STRINGWIDTH(string0, 66);
    IF_SETSIZE(int1, 32, 0, 0, 40697890);
    IF_SETSIZE((int1 + 64), 28, 0, 0, 40697867);
    IF_SETTEXT(string0, 40697890);
    return;
}