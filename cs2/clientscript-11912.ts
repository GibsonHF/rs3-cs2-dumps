...
function script11912(): void {
    var int0 = script9094();
    IF_SETHIDE(1, struct_getparam(int0, 8268));
    ...
    IF_SETGRAPHIC(-1, struct_getparam(int0, 8237));
    IF_SETHIDE(1, struct_getparam(int0, 8934));
    IF_SETHIDE(1, struct_getparam(int0, 8935));
    IF_SETHIDE(0, struct_getparam(int0, 8240));
    script7474(0);
