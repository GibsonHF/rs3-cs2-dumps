//
function script13395(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): void {
    var int7 = 0;
    var int8 = 0;
    var string0 = "0";
    var int9 = 0;
    var int10 = 0;
    IF_SETSIZE(0, 0, 1, 1, 86638603);
    var int11 = (int2 + (2 * 31));
    var int12 = (int3 + (2 * 31));
    var int13 = (int0 - 31);
    var int14 = (int1 - 31);
    ...
    IF_SETPOSITION(int13, int14, 0, 0, 86638596);
    IF_SETSIZE(int11, int12, 0, 0, 86638596);
