//
function script18118(int0: number): void {
    ...
    while ((int7 < int2)) {
        ...
        CC_SETOPCURSOR(1, 46);
        script3537(string0);
        script10033(int7, 2, 0, 0, 1, 1, 4, 4, 1, 1, 4128);
        CC_SETCOLOUR(int3);
        CC_SETFILL(1);
        if ((int7 >= int1)) {
            script10033(int7, 3, 2, 0, 2, 1, 10, 4, 0, 1, 4128);
            CC_SETCOLOUR(int4);
            CC_SETFILL(1);
        };
        int6 = struct_getparam(int5, 2543);
        if ((script2476(int6, 0) == 0)) {
            script7918(int7, 4, 0, 0, 1, 1, 6, 6, 1, 1, 14794);
        };
        int7 = (int7 + 1);
    };
    return;
