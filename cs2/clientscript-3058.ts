//
function script3058(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number, int10: number, int11: number, int12: number, int13: number, int14: number): void {
    var int15 = 0;
    var int16 = 0;
    ...
    if ((int13 == 1)) {
        ...
        if ((int17 > int4)) {
            script2391(int0, int1, int8, int4, int5, 2, 3);
            var int13 = 0;
        };
    };
    if ((int14 == 1)) {
