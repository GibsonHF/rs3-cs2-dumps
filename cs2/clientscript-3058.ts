//
function script3058(int0: component, int1: int, int2: int, int3: int, int4: int, int5: int, int6: int, int7: int, int8: int, int9: int, int10: int, int11: unknown_int, int12: unknown_int, int13: unknown_int, int14: unknown_int): void {
    var int15 = 0;
    var int16 = 0;
