//
function script12444(int0: number, int1: number, int2: number, int3: number): void {
    var int4 = 0;
    var int5 = 0;
    var int6 = 0;
    ...
    IF_SETONMOUSEREPEAT(callback(script10817, -2147483647, -2147483646, int0, int1), comp(475, 7));  // machinima_livecamera:mouselistener
    return;
}