...
function script18819(): void {
    ...
    stack(int0);
    int0 = (int0 + 1);
    script2994(0, 0, 1, 1, 0, 0, 1, 1, 33674);
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    ...
    stack(int0);
    int0 = (int0 + 1);
    script2997(-160, 10, 1, 1, 32, 32, 0, 0);
    CC_SETMODEL(132944 as model);
    CC_SETMODELANGLE(0, 0, 100, 300, 0, 900);
    script18821(31981632, (int0 - 2), int1, int2);
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    script2994(370, -25, 1, 1, 580, 200, 0, 0, 33864);
    CC_SETHFLIP(true);
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    script2994(0, -25, 1, 1, 175, 175, 0, 0, -1);
    CC_SETOBJECT_HIGHRES(53207 as obj);
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    script2994(0, 10, 1, 0, 372, 38, 0, 0, script235(33675, 33676, 33677, 33678));
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    script2994(0, 30, 1, 2, 566, 90, 0, 0, 26159);
    stack(31981632);
    stack(int0);
    int0 = (int0 + 1);
    script2995(0, 50, 1, 2, 566, 55, 0, 0, callback());
