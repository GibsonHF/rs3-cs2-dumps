//
function script9078(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number): number {
    var string0 = "";
    var int8 = 0;
    var int9 = 5;
    string0 = script9533(int4, int5, int3, int6);
    if ((strcmp(string0, "") != 0)) {
        int8 = script7593(string0, (int2 - (15 * 2)), 26, 14);
        int9 = (int9 + int8);
        int9 = (int9 + 5);
    };
    ...
    if ((int10 > 0)) {
        ...
        if ((TESTBIT(int10, 1) == 1)) {
            ...
            int12 = script7593(string1, (int2 - (15 * 2)), 26, 14);
            int9 = (int9 + int12);
            int9 = (int9 + 5);
        };
    };
