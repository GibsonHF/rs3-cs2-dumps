//
function script6312(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): void {
    CC_DELETEALL(int1);
    CC_DELETEALL(int5);
    var int7 = INV_GETOBJ(398, (int0 - 1));
    if (((int7 == -1) || (int7 == 8245))) {
        IF_SETHIDE(1, int2);
        IF_SETHIDE(1, int3);
        IF_SETHIDE(1, int4);
    ...
    if ((TESTBIT(varclient_841, int0) == 0)) {
        script13994(int2, -1, 28556, "", 1);
    } else {
        script13994(int2, -1, 28556, "", 0);
    };
    var int8 = 0;
