...
function script2002(): number {
    var int0 = 0;
    if ((script12952() == 1)) {
        if ((varbitplayer_15630 == 1)) {
            if ((STAT_BASE(1 as stat) >= 37)) {
                if ((varbitplayer_15560 > 159)) {
                    int0 = 0;
                } else {
                    int0 = (160 - varbitplayer_15560);
                };
            } else if ((varbitplayer_15548 == 1)) {
                if ((STAT_BASE(1 as stat) >= 35)) {
                    if ((varbitplayer_15560 > 127)) {
                        int0 = 0;
                    } else {
                        int0 = (128 - varbitplayer_15560);
                    };
                } else if ((varbitplayer_15547 == 1)) {
                    if ((STAT_BASE(1 as stat) >= 35)) {
