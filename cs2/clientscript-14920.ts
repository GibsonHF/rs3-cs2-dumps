...
function script14920(int0: number): void {
        ...
        while ((++int10 < int4)) {
            ...
            if ((int7 != -1)) {
                ...
                if ((script14502(int7) == 2)) {
                    script7924(int1, IF_GETNEXTSUBID(int1), 26, 26, (((IF_GETWIDTH(int1) - (2 * 4)) - 50) - 26), (int9 + 4), 28293, 0, 0, 0, 0);
                    script3537(`${inttostring(script14504(int7), 10)}/${inttostring(DB_GETFIELDCOUNT(int7, 344272), 10)}`);
                } else {
                    script152(int1, 26, 26, (((IF_GETWIDTH(int1) - (2 * 4)) - 50) - 26), (int9 + 4), 26, `${inttostring(script14504(int7), 10)}/${inttostring(DB_GETFIELDCOUNT(int7, 344272), 10)}`, 16777215);
                    CC_SETTEXTALIGN(1, 1, 0);
                };
                script10410(int1, int2, 28556, ((IF_GETWIDTH(int1) - 4) - 50), (int9 + 4), 50, (36 - (2 * 4)), int10, 0, "Info");
    ...
    IF_SETSCROLLSIZE(0, MAX(IF_GETHEIGHT(45482022), (int9 - 4)), 45482022);
    IF_SETSCROLLPOS(0, 0, 45482022);
