...
function script6782(): void {
    ...
    while ((int3 != -1 as dbrow)) {
        if (((DB_GETFIELDCOUNT(int3, 663648) > 0) && (script6734(int3) == 1))) {
            ...
            script7920(int0, int1, 1, int1, 0, 0, 0, 1, 1, 40, 40, 0, 0, 2022);
    ...
    IF_SETTEXT(`Bonus Prizes  <col=FFFFFF>(${inttostring(int1, 10)})</col>`, 82116925);
    if ((CC_FIND(int0, 0) == 1)) {
    ...
    IF_SETTEXT(`(${inttostring(int1, 10)})`, 82116926);
    return;
}