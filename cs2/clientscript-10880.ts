//
function script10880(int0: number, int1: number, int2: number, int3: number, string0: string): void {
    var int4 = script10495(3);
    var string1 = "";
    if ((int3 == 1)) {
        int4 = 16777215;
    };
    CC_CREATE(103350277, 4, (int1 - 1));
    CC_SETSIZE(0, 25, 1, 0);
