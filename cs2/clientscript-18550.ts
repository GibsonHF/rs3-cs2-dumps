    ...
    if ((struct_getparam(int3, 4852) != -1 as graphic)) {
        ...
        if ((struct_getparam(int3, 9078) == 1)) {
            if ((int14 == 5)) {
                ...
                CC_SETMODELANGLE(struct_getparam(int3, 9081), struct_getparam(int3, 9082), struct_getparam(int3, 9083), struct_getparam(int3, 9084), struct_getparam(int3, 9085), struct_getparam(int3, 9080));
                CC_SETPOSITION(int18, int19, 0, 0);
                CC_SETSIZE(120, 120, 0, 0);
