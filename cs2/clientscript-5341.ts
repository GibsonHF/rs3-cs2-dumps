//
function script5341(int0: number): void {
    if ((int0 == 2)) {
        varclient_1278 = 2;
        ...
        IF_SETGRAPHIC(18526, 3538952);
        IF_SETGRAPHIC(18525, 3539072);
        IF_SETGRAPHIC(18526, 3539074);
    } else if ((int0 == 3)) {
        varclient_1278 = 3;
        if ((varbitplayer_4185 == 1)) {
        ...
        IF_SETGRAPHIC(18526, 3538952);
        IF_SETGRAPHIC(18526, 3539072);
        IF_SETGRAPHIC(18525, 3539074);
    } else {
        varclient_1278 = 1;
        if ((varbitplayer_4185 == 1)) {
