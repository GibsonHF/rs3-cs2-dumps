//
function script2770(int0: number, int1: number): void {
    switch (varclient_1007) {
        case 1: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60298061, int1), 600, script2764(60298061, int1), 600, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60298061, int1), 450, script2764(60298061, int1), 450, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60298068, int1), 100, script2764(60298068, int1), 100, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60298073, int1), 100, script2764(60298073, int1), 100, 0);
        ...
        case 4: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60363602, int1), 450, script2764(60363601, int1), 450, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60330828, int1), 600, script2764(60330829, int1), 600, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60298065, int1), 400, script2764(60298066, int1), 400, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60298067, int1), 350, script2764(60298066, int1), 350, 0);
            CAM_MOVEALONG(0, 0, 250, 200, 1, 0);
            break;
        }
        case 5: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60363601, int1), 700, script2764(60363601, int1), 700, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60363601, int1), 700, script2764(60363601, int1), 700, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60298062, int1), 350, script2764(60298061, int1), 350, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60298061, int1), 150, script2764(60298061, int1), 350, 0);
            CAM_MOVEALONG(0, 0, 100, 100, 1, 0);
            break;
        }
        case 6: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60347213, int1), 450, script2764(60347214, int1), 450, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60314446, int1), 450, script2764(60314446, int1), 450, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60298065, int1), 400, script2764(60298066, int1), 400, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60298067, int1), 400, script2764(60298066, int1), 400, 0);
            CAM_MOVEALONG(0, 0, 60, 60, 1, 0);
            break;
        }
        case 7: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60314446, int1), 400, script2764(60314445, int1), 400, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60314444, int1), 400, script2764(60314445, int1), 400, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60248909, int1), 350, script2764(60248909, int1), 350, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60248909, int1), 350, script2764(60248909, int1), 350, 0);
            CAM_MOVEALONG(0, 0, 30, 30, 1, 0);
            break;
        }
        case 8: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60363605, int1), 450, script2764(60363604, int1), 450, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60347219, int1), 450, script2764(60363604, int1), 450, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60330836, int1), 400, script2764(60314453, int1), 400, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60298069, int1), 400, script2764(60314453, int1), 400, 0);
            CAM_MOVEALONG(0, 0, 150, 150, 1, 0);
            break;
        }
        case 9: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60363601, int1), 500, script2764(60330833, int1), 500, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60248912, int1), 700, script2764(60248913, int1), 700, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60330828, int1), 250, script2764(60330828, int1), 250, 0);
            SPLINE_ADDPOINT(1, 1, script2764(60347212, int1), 250, script2764(60347212, int1), 250, 0);
            CAM_MOVEALONG(0, 0, 30, 30, 1, 0);
            break;
        }
        case 10: {
            SPLINE_NEW(0, 2);
            SPLINE_ADDPOINT(0, 0, script2764(60363593, int1), 800, script2764(60363593, int1), 800, 0);
            SPLINE_ADDPOINT(0, 1, script2764(60363591, int1), 600, script2764(60363591, int1), 600, 0);
            SPLINE_NEW(1, 2);
            SPLINE_ADDPOINT(1, 0, script2764(60298064, int1), 500, script2764(60298064, int1), 500, 0);
