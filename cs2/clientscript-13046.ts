//
function script13046(int0: number, int1: number): void {
    if ((int1 != 1)) {
        return;
    };
    var string0 = "";
    ...
    if ((enum_getvalue(0, 1, 12137 as cs2enum, int5) == true)) {
        int2 = 1;
    } else if (((int6 == 1) && (enum_getvalue(0, 1, 15778 as cs2enum, int5) == true))) {
        int2 = 1;
    };
