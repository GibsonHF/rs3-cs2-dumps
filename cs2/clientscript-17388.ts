//
function script17388(int0: number, int1: number): void {
    var int2 = 0;
    if ((varplayer_139 == 1)) {
        if ((OC_CERT(varplayer_135) != varplayer_135)) {
            int2 = script11882(INV_TOTAL(93, varplayer_135), INV_TOTAL(93, OC_CERT(varplayer_135)));
        } else {
            int2 = INV_TOTAL(93, varplayer_135);
        };
        if ((int0 == 1000)) {
            varclient_84 = int2;
        } else if ((int1 == 1)) {
