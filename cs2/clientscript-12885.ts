        ...
        if ((struct_getparam(int0, 6140) != -1 as obj)) {
            if ((int3 == 0)) {
                ...
                if ((struct_getparam(int0, 6161) > -1)) {
                    ...
                    CC_SETCOLOUR(16777215);
                    int6 = (int6 + (CC_GETHEIGHT() + 8));
                    if ((struct_getparam(int0, 5806) == 0)) {
                        stack(int1);
                        stack(4);
                        stack(int3);
                        int3 = (int3 + 1);
                        ...
                        while ((int14 < int18)) {
                            ...
                            CC_SETGRAPHIC(enum_getvalue(0, 23, 8548, push_array[1](int14)));
                            CC_SETONMOUSEREPEAT(callback(script8799, enum_getvalue(0, 36, 108, push_array[1](int14)), -2147483645, -2147483643));
                            stack(int1);
                            stack(4);
                            stack(int3);
                            int3 = (int3 + 1);
            ...
            int6 = 0;
            int5 = 6;
            if ((((int4 == 0) && (struct_getparam(int0, 6273) != -1)) && (struct_getparam(int0, 6274) != -1))) {
                stack(int2);
                stack(4);
                stack(int4);
                int4 = (int4 + 1);
                ...
                if ((struct_getparam(int0, 9247) == 1)) {
                    script7858(1, 0, int5, int6, 1, 0, 200, 30, 0, 0, 17062, "View Prizes");
                    CC_SETOP(1, "View Prizes");
                    int6 = (int6 + (CC_GETHEIGHT() + 30));
                } else if ((struct_getparam(int0, 6149) != -1)) {
                    stack(int2);
                    stack(4);
                    stack(int4);
                    int4 = (int4 + 1);
