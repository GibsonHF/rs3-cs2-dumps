//[proc,notes_click]
function script2449(int0: number, int1: number): void {
    var int2 = 0;
    var int3 = script7799(int0, 2228236);
    var int4 = script7799(int0, 2228230);
    var int5 = script7799(int0, 2228239);
    while ((CC_FINDBYCATEGORY(int3, int2, 0) == 1)) {
        CC_SETOP(1, "Select");
        int2 = (int2 + 1);
    };
    if ((varplayer_98 != -1)) {
        if ((CC_FINDBYCATEGORY(int3, varplayer_98, 0) == 1)) {
            CC_SETOP(1, "Unselect");
            if ((IF_GETHIDE(script7799(int0, 2228237)) == false)) {
