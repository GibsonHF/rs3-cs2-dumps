...
function script8186(int0: number): void {
    ...
    while ((int6 < int7)) {
        ...
        if ((((varbitplayer_38842 == 1) && (int8 != -1)) && (struct_getparam(int8, 7130) != -1 as struct))) {
        ...
        if ((int8 != -1)) {
            if (((struct_getparam(int8, 5327) == false) || (int36 == 1))) {
                if ((varbitplayer_38842 == 0)) {
                    if ((varbitplayer_27169 == 0)) {
                        ...
                        if ((struct_getparam(int8, 8266) == false)) {
                            if (((1 + int6) == int37)) {
                                int38 = int8;
                            };
                            int26 = struct_getparam(int2, 3612);
                    ...
                    if ((struct_getparam(int8, 8265) == false)) {
                        if ((varbitplayer_27169 == 0)) {
                            if (((1 + int6) == int37)) {
                                int38 = int8;
                            };
