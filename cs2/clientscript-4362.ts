...
function script4362(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number, int10: number, int11: number, long0: bigint): void {
    if ((((int9 == 0) || (int8 == 0)) || (int6 == 0))) {
        IF_SETGRAPHIC(5936 as graphic, int2);
        return;
    };
    ...
    if ((int9 == 261)) {
        string0 = `${string0}<br><br>N/A - <br>${enum_getvalue(0, 36, 3696, int8)}<br><br>${enum_getvalue(0, 36, 3687, int6)}`;
    } else {
        string0 = `${string0}<br><br>World ${inttostring(int9, 10)} - <br>${enum_getvalue(0, 36, 3696, int8)}<br><br>${enum_getvalue(0, 36, 3687, int6)}`;
    };
    if (((int12 != -1) && (int7 > 0))) {
        string0 = `${string0}<br>${enum_getvalue(0, 36, int12, int7)}`;
    };
    string0 = `${string0}<br><br>Open to ${enum_getvalue(0, 36, 3716, int10)}`;
    if ((int11 == 1)) {
    ...
    IF_SETGRAPHIC(5932 as graphic, int2);
    return;
}