...
function script11153(int0: number): number {
    ...
    if ((STAT_BASE(11 as stat) >= 82)) {
        if ((MAP_MEMBERS() == 1)) {
            ...
            int1 = 2025;
        } else if ((MAP_MEMBERS() == 1)) {
            if ((STAT_BASE(11 as stat) >= 58)) {
                int1 = 1935;
            } else if ((MAP_MEMBERS() == 1)) {
                if ((STAT_BASE(11 as stat) >= 50)) {
                    int1 = 1575;
                } else if ((STAT_BASE(11 as stat) >= 45)) {
                    int1 = 1350;
                } else if ((MAP_MEMBERS() == 1)) {
                    if ((STAT_BASE(11 as stat) >= 42)) {
                        int1 = 1250;
                    } else if ((MAP_MEMBERS() == 1)) {
                        if ((STAT_BASE(11 as stat) >= 35)) {
                            int1 = 1050;
