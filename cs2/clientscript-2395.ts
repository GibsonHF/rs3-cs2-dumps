//
function script2395(int0: number, int1: number, int2: number, int3: number): void {
    ...
    var int7 = 0;
    if ((int3 == 37158928)) {
        if ((((int6 == -1) || (IF_GETLAYER(int1) == 37158928)) || (script13863(int0, -1, int1, int2) == 0))) {
            return;
        };
        int7 = -1;
        ...
        int4 = script8403(37158919);
        int5 = script8404(37158919);
        int7 = ((int4 - 0) / 44);
        if ((int5 > (2 + (44 * 2)))) {
            int7 = (int7 + (15 * 2));
        } else if ((int5 > (2 + 44))) {
    ...
    if ((((PLAYERMEMBER() == 0) && (int0 == script2390(7))) && (IF_FIND(93782017) == 1))) {
