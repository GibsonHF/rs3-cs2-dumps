//
function script2963(int0: number, int1: number, int2: number): void {
    if ((FRIEND_COUNT() < 0)) {
        return;
    };
    ...
    while ((int24 < int26)) {
        ...
        if (((CC_FIND(int7, int24) == 1) && (CC_FIND[1](int6, int24) == 1))) {
            if (((int25 > 0) && (((STRING_INDEXOF_STRING(FRIEND_GETWORLDNAME(int24), "RuneScape", 0) != -1) || (TESTBIT(unk11120(int24), 16) == 1)) || (TESTBIT(unk11120(int24), 20) == 1)))) {
