//
function script18670(int0: number, int1: number, string0: string): string {
    var int2 = 22;
    var int3 = 6;
    var int4 = 2;
    var int5 = 4;
    ...
    string0 = `${string0}<br>- The final attack instead deals ${script17720(48309, 117, (117 + 26), 0, int1)} to the target plus <col=ffffff>${inttostring(100, 10)}%</col> of the total heal value.`;
    return string0;
}