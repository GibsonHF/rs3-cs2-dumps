//
function script6138(int0: number): void {
    var int1 = 30;
    var int2 = 180;
    var int3 = 0;
    var int4 = 14;
    var int5 = ((int2 - int1) / int4);
    var int6 = (IF_GETWIDTH(83230733) + int1);
    var int7 = (IF_GETHEIGHT(83230733) + int1);
    var int8 = -1;
    var int9 = -1;
    var int10 = (int6 / 2);
    var int11 = (int7 / 2);
    ...
    int10 = (IF_GETWIDTH(83230733) / 2);
    int11 = (IF_GETHEIGHT(83230733) / 2);
