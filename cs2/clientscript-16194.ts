//
function script16194(int0: number): void {
    IF_SETOP(1, "", int0);
    script10026(int0, 0, 0, 0, 1, 1, 0, 0, 1, 1, 0, 5);
    if ((IF_CREATENESTED(0, 1, 0, 0, 0, int0) == 1)) {
        CC_SETSIZE(0, 0, 1, 1);
        script7863(int0, 1, 1, 1, 0, 0, 0, 1, 1, 0, 0, 1, 1, 4476, "");
        CC_SETOP(1, "Select");
    ...
    if ((IF_CREATENESTED(0, 2, 0, 0, 0, int0) == 1)) {
        CC_SETSIZE(0, 0, 1, 1);
        script7863(int0, 2, 1, 2, 0, 0, 0, 1, 1, 0, 0, 1, 1, 4476, "");
        CC_SETOP(1, "Select");
    ...
    if ((IF_CREATENESTED(0, 3, 0, 0, 0, int0) == 1)) {
        CC_SETSIZE(0, 0, 1, 1);
        script7863(int0, 3, 1, 3, 0, 0, 0, 1, 1, 0, 0, 1, 1, 4476, "");
        CC_SETOP(1, "Select");
