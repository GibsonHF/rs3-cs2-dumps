...
function script18202(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, string0: string): void {
    ...
    while ((int15 != -1)) {
        if (((int8 != -1 as struct) && (int9 != -1 as struct))) {
            ...
            if ((int10 != comp(-1, 65535))) {
                if ((int13 != comp(-1, 65535))) {
                    ...
                    if ((IF_FIND[1](int10) == 1)) {
                        if ((cc_getparam[1](6361) != dbrow_getfield(int15, 667648, 0))) {
                        ...
                        } else if (((dbrow_getfield(int15, 667776, 0) == 13) && (strcmp(string1, cc_getparam[1](2533)) != 0))) {
                            cc_setparam[1](6361, dbrow_getfield(int15, 667648, 0));
                            CC_SETPARAM_STRING[1](2533, string1);
                            cc_setparam[1](6360, -1);
                            cc_setparam[1](5945, -1);
                    ...
                    int7 = (int7 + 1);
                    int8 = enum_getvalue(int7);
                    int9 = enum_getvalue(0, 73, 8601, int7);
                    int21 = (int21 + 1);
                    [int15, int0] = script18193(int15, int21, int0, int6, string0, int2, int3, int4);
                    int16 = -1;
                } else {
        ...
        while ((int8 != -1)) {
            if ((IF_FIND[1](IF_GETLAYER(struct_getparam(int8, 4037))) == 1)) {
                if ((CC_GETWIDTH[1]() != 0)) {
            ...
            if (((int9 != -1) && (enum_getreversecount(73, 8601 as cs2enum, int9) > 0))) {
