...
function script4(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, string0: string): void {
    ...
    if ((int14 == -1)) {
        script2048(int0, 0, struct_getparam(int2, 130), int12, int13, 0, 0, 0, 0, 0, 0, 0, string2, string1, int1);
        int15 = (int13 / 2);
        int16 = (int13 / 2);
        int17 = (int12 / 2);
        int18 = (int12 / 2);
        ...
        switch (int14) {
            case 0: {
                script2048(int0, 0, struct_getparam(int2, 134), int12, int13, 0, (0 - (int13 / 2)), 49152, 0, 0, 0, 0, string2, string1, int1);
                int15 = int13;
                int16 = 0;
                int17 = (int12 / 2);
                int18 = (int12 / 2);
            ...
            case 1: {
                script2048(int0, 0, struct_getparam(int2, 135), int12, int13, (int12 / 2), (0 - (int13 / 2)), 32768, 0, 0, 0, 0, string2, string1, int1);
                int15 = int13;
                int16 = 0;
                int17 = 0;
                int18 = int12;
            ...
            case 2: {
                script2048(int0, 0, struct_getparam(int2, 134), int12, int13, (int12 / 2), 0, 32768, 0, 0, 0, 0, string2, string1, int1);
                int15 = (int13 / 2);
                int16 = (int13 / 2);
                int17 = 0;
                int18 = int12;
            ...
            case 3: {
                script2048(int0, 0, struct_getparam(int2, 135), int12, int13, (int12 / 2), (int13 / 2), 16384, 0, 0, 0, 0, string2, string1, int1);
                int15 = 0;
                int16 = int13;
                int17 = 0;
                int18 = int12;
            ...
            case 4: {
                script2048(int0, 0, struct_getparam(int2, 134), int12, int13, 0, (int13 / 2), 16384, 0, 0, 0, 0, string2, string1, int1);
                int15 = 0;
                int16 = int13;
                int17 = (int12 / 2);
                int18 = (int12 / 2);
            ...
            case 5: {
                script2048(int0, 0, struct_getparam(int2, 135), int12, int13, (0 - (int12 / 2)), (int13 / 2), 0, 0, 0, 0, 0, string2, string1, int1);
                int15 = 0;
                int16 = int13;
                int17 = int12;
                int18 = 0;
            ...
            case 6: {
                script2048(int0, 0, struct_getparam(int2, 134), int12, int13, (0 - (int12 / 2)), 0, 0, 0, 0, 0, 0, string2, string1, int1);
                int15 = (int13 / 2);
                int16 = (int13 / 2);
                int17 = int12;
                int18 = 0;
            ...
            case 7: {
                script2048(int0, 0, struct_getparam(int2, 135), int12, int13, (0 - (int12 / 2)), (0 - (int13 / 2)), 49152, 0, 0, 0, 0, string2, string1, int1);
                int15 = int13;
                int16 = 0;
                int17 = int12;
                int18 = 0;
