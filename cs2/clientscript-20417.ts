...
function script20417(): void {
    ...
    switch (varbitplayer_60340) {
        case 1: {
            ...
            IF_SETTEXT(script20418(7435, 8685), int2);
        ...
        case 2: {
            ...
            IF_SETTEXT(script20418(15492, 8692), int2);
        ...
        case 3: {
            ...
            IF_SETTEXT(script20418(17162, 8699), int2);
        ...
        case 4: {
            ...
            IF_SETTEXT(script20418(17268, 8706), int2);
        ...
        default: {
            ...
            IF_SETTEXT(script20418(7433, 8678), int2);
