...
function script10601(int0: component, int1: component, int2: component, int3: component): void {
    ...
    while ((int4 < 32)) {
        ...
        CC_SETOBJECT_NONUM(enum_getvalue(0, 33, 9243 as cs2enum, int4), TESTBIT(varclient_4615, int4));
        if ((MODULO(int4, 2) == 0)) {
            ...
            int12 = CC_GETX[1]();
            CC_SETGRAPHIC[1](enum_getvalue(0, 23, 9246 as cs2enum, int11));
        ...
        if ((TESTBIT(varclient_4615, int4) == 1)) {
