//
function script6563(int0: number, int1: number, int2: number): void {
    var int3 = -1;
    var int4 = 0;
    ...
    while ((int3 < int11)) {
        ...
        if ((int14 != -1 as obj)) {
            ...
            int9 = script7593(string1, int6, 26, 0);
            int7 = MAX(30, (((10 + int8) + 5) + int9));
            int10 = (int4 + 5);
            script2682(int0, int5, int7, 0, int4, 1, int3);
            script6204(int0, int5, int7, 0, int4, 0, 2438);
            script10629(int0, IF_GETNEXTSUBID(int0), (int6 - 10), int8, 5, int10, string0, 0, 26, 0, 0, 0, 0);
            script2731(int0, CC_GETID(), 2);
            int10 = (int10 + (int8 + 5));
            script10629(int0, IF_GETNEXTSUBID(int0), (int6 - 10), int9, 5, int10, string1, 0, 26, 0, 0, 0, 0);
            script2731(int0, CC_GETID(), 3);
            if ((varbitplayer_44082 != 1)) {
                if ((int15 == 1)) {
                    int16 = script6428(0, int12);
                    script10410(int0, int1, 28556, (int6 - 5), (int4 + ((int7 / 2) - ((int7 - 10) / 2))), 75, (int7 - 10), IF_GETNEXTSUBID(int1), int16, "Activate");
                    if (((int16 == 0) && (CC_FIND(int1, int3) == 1))) {
                ...
                int16 = script6428(0, int12);
                script12501(int0, int1, 28556, (int6 - 5), (int4 + ((int7 / 2) - ((int7 - 10) / 2))), 75, (int7 - 10), IF_GETNEXTSUBID(int1), int16, "Exchange");
