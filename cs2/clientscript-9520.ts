...
function script9520(int0: number, int1: number, int2: number, int3: number): void {
    ...
    switch (int2) {
        ...
        case 2: {
            ...
            string0 = enum_getvalue(0, 36, 8112, 0);
            break;
        }
        case 3: {
            int4 = varbitplayer_21176;
            string0 = enum_getvalue(0, 36, 8112, 1);
            break;
        }
        case 4: {
            int4 = varbitplayer_21177;
            string0 = enum_getvalue(0, 36, 8112, 5);
            break;
        }
        case 5: {
            int4 = varbitplayer_21178;
            string0 = enum_getvalue(0, 36, 8112, 11);
            break;
        }
        case 6: {
            int4 = varbitplayer_21179;
            string0 = enum_getvalue(0, 36, 8112, 15);
            break;
        }
        case 7: {
            int4 = varbitplayer_21180;
            string0 = enum_getvalue(0, 36, 8112, 10);
            break;
        }
        case 8: {
            int4 = varbitplayer_21181;
            string0 = enum_getvalue(0, 36, 8112, 14);
            break;
        }
        case 9: {
            int4 = varbitplayer_21182;
            string0 = enum_getvalue(0, 36, 8112, 2);
            break;
        }
        case 10: {
            int4 = varbitplayer_21183;
            string0 = enum_getvalue(0, 36, 8112, 7);
            break;
        }
        case 11: {
            int4 = varbitplayer_21184;
            string0 = enum_getvalue(0, 36, 8112, 12);
            break;
        }
        case 12: {
            int4 = varbitplayer_21185;
            string0 = enum_getvalue(0, 36, 8112, 17);
            break;
        }
        case 13: {
            int4 = varbitplayer_21186;
            string0 = enum_getvalue(0, 36, 8112, 4);
            break;
        }
        case 14: {
            int4 = varbitplayer_21187;
            string0 = enum_getvalue(0, 36, 8112, 9);
            break;
        }
        case 15: {
            int4 = varbitplayer_21188;
            string0 = enum_getvalue(0, 36, 8112, 16);
            break;
        }
        case 16: {
            int4 = varbitplayer_21189;
            string0 = enum_getvalue(0, 36, 8112, 3);
            break;
        }
        case 17: {
            int4 = varbitplayer_21190;
            string0 = enum_getvalue(0, 36, 8112, 8);
            break;
        }
        case 18: {
            int4 = varbitplayer_21191;
            string0 = enum_getvalue(0, 36, 8112, 13);
            break;
        }
    };
    switch (int4) {
