//
function script13289(int0: number): [number, number, number] {
    ...
    while ((int1 < int2)) {
        ...
        if ((int6 != -1 as struct)) {
            if ((script15085(int0) == 1)) {
                if ((script12477() < struct_getparam(int6, 7895))) {
                    if ((script13280(int6) == -2)) {
                        int4 = (int4 + 1);
                        int3 = (int3 + 1);
