//
function script14874(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, string0: string, string1: string): void {
    var int6 = 0;
    var int7 = 0;
    var int8 = 0;
    ...
    if ((int8 > 0)) {
        script7924(int0, IF_GETNEXTSUBID(int0), 22, 22, int1, (int2 + ((int4 - 22) / 2)), 10316, 0, 0, 0, 0);
        script6203(int0, ((int8 - 22) - 5), int4, ((int1 + 22) + 5), int2, 26, string1, 3);
        CC_SETTEXTALIGN(0, 1, 0);
        CC_SETTEXTSHADOW(int5);
        int1 = (int1 + int7);
        int6 = (int6 - 1);
