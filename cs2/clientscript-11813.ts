...
function script11813(int0: number): void {
    ...
    if ((script8314(1003) != -1)) {
        script11815(1430, int4, string0, int0);
    };
    if ((script8314(1032) != -1)) {
        script11815(1670, int4, string0, int0);
    };
    if ((script8314(1033) != -1)) {
        script11815(1671, int4, string0, int0);
    };
    if ((script8314(1034) != -1)) {
        script11815(1672, int4, string0, int0);
    };
    if ((script8314(1035) != -1)) {
        script11815(1673, int4, string0, int0);
    };
    if ((script8314(1043) != -1)) {
        script11815(1924, int4, string0, int0);
    };
    if ((script8314(1044) != -1)) {
        script11815(1925, int4, string0, int0);
    };
    if ((int0 != 4)) {
        IF_SETONTIMER(callback(script11813, 0), comp(1477, 6));  // toplevel_v2:global_cooldown_timer
    } else {
        IF_SETONTIMER(callback(), comp(1477, 6));  // toplevel_v2:global_cooldown_timer
    };
    return;
}