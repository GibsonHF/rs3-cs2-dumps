...
function script1063(int0: number, int1: number, int2: number): void {
    ...
    CC_SETTEXT(string0);
    CC_SETTEXTSHADOW(1);
    CC_SETSIZE(PARAWIDTH(string0, IF_GETWIDTH(int0), 26), IF_GETHEIGHT(int0), 0, 0);
    IF_SETHIDE(0, int3);
    ...
    while ((int6 < int5)) {
        ...
        CC_SETTEXT(string0);
        CC_SETTEXTSHADOW(1);
        int8 = PARAWIDTH(string0, IF_GETWIDTH(int0), 26);
        if ((int8 > int9)) {
            int9 = int8;
        };
        int6 = (int6 + 1);
