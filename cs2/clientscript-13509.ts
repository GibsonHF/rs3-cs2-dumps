...
function script13509(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number): void {
    ...
    if ((CC_FIND(int1, int2) == 1)) {
        ...
        int17 = SUB(CC_GETSCROLLY((int17 + CC_GETY())));
    };
    var int18 = int1;
    var int19 = 0;
    if ((int5 == 1)) {
        while ((int18 != int7)) {
            if ((int18 != comp(-1, 65535))) {
            ...
            if ((varclient_4105 != -1)) {
                if ((int38 != 1)) {
                    ...
                    int14 = IF_GETSCROLLX(int9);
                    int37 = 1;
                } else if (((int38 == 1) && (varclient_4105 != varclient_3466))) {
                    script2015(int0);
                    int13 = IF_GETSCROLLWIDTH(int9);
                    int14 = IF_GETSCROLLX(int9);
                    int37 = 1;
    ...
    [int24, int25] = script8405(int12);
    [int22, int23] = script8716(int0);
    int28 = struct_getparam(int6, 3494);
    if ((int28 != -1 as struct)) {
        [int26, int27] = script20539(struct_getparam(int6, 3494));
        if ((int22 < int26)) {
            int22 = MAX(IF_GETWIDTH(int7), int26);
    ...
    int29 = ((int24 + IF_GETWIDTH(int12)) - IF_GETWIDTH(int7));
    int30 = ((int25 + IF_GETHEIGHT(int12)) - IF_GETHEIGHT(int7));
    int20 = MAX(int24, MIN(int20, int29));
    int21 = MAX(int25, MIN(int21, int30));
    IF_SETPOSITION(int20, int21, 0, 0, int7);
    IF_SETSIZE(int22, int23, 0, 0, int7);
    script8308(int0, script8717(int0), int20, int21, IF_GETWIDTH(int7), IF_GETHEIGHT(int7));
    int31 = script10405(varclient_3466);
    int32 = script8418(int31, 0);
    int33 = struct_getparam(int31, 3503);
    int34 = struct_getparam(int31, 3509);
    int35 = -1;
    IF_SETHIDE(false, int7);
    script8691(script8717(int0));
    int36 = 0;
    int37 = 0;
    int38 = script8309(int0);
    if ((varclient_4105 != -1)) {
        if ((int38 != 1)) {
            script2015(int0);
            int13 = IF_GETSCROLLWIDTH(int9);
