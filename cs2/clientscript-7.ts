...
function script7(int0: number): [number, number] {
    ...
    if (((varplayer_623 == -1 as npc_uid) && (varplayer_616 == -1 as player_uid))) {
        if ((((varbitplayer_38842 == 0) || (varplayer_7879 != 1)) || (varbitclient_41275 == 1))) {
            script38();
            return [-1, -1];
        };
    };
    ...
    } else if (((varbitplayer_22332 == 1) && (varbitplayer_27170 >= 2))) {
        [int1, int2, int3, int4, int5] = GET_ENTITY_BOUNDING_BOX();
        if ((int1 == 0)) {
            script38();
            return [-1, -1];
