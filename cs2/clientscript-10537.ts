...
function script10537(string0: string): string {
    var string0 = `${string0}- Attacks apply a <sprite=30335><nbsp><col=ffffff>${struct_getparam(1489, 2794)}</col> stack with each hit, storing <col=ffffff>${script18566(-1, (10 / 10), 0)}.`;
