//
function script16557(int0: number, int1: number, int2: number): [number, number] {
    var int3 = 0;
    var int4 = 0;
        ...
        switch (int18) {
            case 0: {
                if ((int2 == 1)) {
                    ...
                    CC_SETHFLIP(int21);
                    script10485(int4, 3, 6, 0, 2, 0, ((int13 + 4) + 12), 0, 1, 1, 5999, string0);
            ...
            case 1: {
                ...
                script10485(int4, 1, 0, 0, 0, 0, 0, 0, 1, 1, 5999, string0);
                int16 = 0;
                break;
            }
            case 2: {
                ...
                CC_SETHFLIP(int21);
                script10485(int4, 2, 0, 0, 2, 0, int13, 0, 1, 1, 5999, string0);
                CC_SETCOLOUR(16777215);
                if ((int2 == 1)) {
