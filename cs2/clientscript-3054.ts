//
function script3054(int0: number, int1: number, int2: number): void {
    ...
    var int10 = -1;
    var int11 = -1;
    [int7, string1, int8, string2, string3, string4, string5, int9, string6, int10, int11] = unk11059(int4);
    var int12 = 1;
    var int13 = 0;
    var int14 = 0;
        ...
        if ((int7 != -1)) {
            ...
            switch (int7) {
                ...
                case 3: {
                    ...
                    if ((int12 == 1)) {
                        [varclient_2505, int12] = [REMOVETAGS(string3), 0];
                    };
                    break;
                }
                case 5: {
