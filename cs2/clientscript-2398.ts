...
function script2398(int0: number, int1: number, string0: string, string1: string): void {
    ...
    if ((STRINGWIDTH(string0, int3) > int4)) {
        string2 = "";
        while ((STRINGWIDTH(`${string0}...`, int3) > int4)) {
            ...
            if ((STRINGWIDTH(string1, int3) > int4)) {
                string3 = "";
                while ((STRINGWIDTH(`${string1}...`, int3) > int4)) {
            ...
            int5 = script8049(int0, 72679450);
            int6 = script8049(int0, 72679449);
            int7 = script8049(int0, 72679453);
            int8 = 0;
            int9 = 0;
            if ((script1891() == 1)) {
                int8 = 185;
    ...
    if ((STRINGWIDTH(string1, int3) > int4)) {
        ...
        while ((STRINGWIDTH(`${string1}...`, int3) > int4)) {
            if ((STRING_LENGTH(string1) > 0)) {
                string1 = SUBSTRING(string1, 0, (STRING_LENGTH(string1) - 1));
                int2 = 1;
            };
            string1 = `${string1}...`;
            IF_SETTEXT(`${string2}<col=ffff64>${string0}</col>${string4}${string3}<col=ffff64>${string1}`, int1);
