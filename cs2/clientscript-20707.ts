//
function script20707(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): number {
    var int7 = -1;
    [int7, int2] = script14749(int0, 0, int2, int3, 0);
    var int8 = int2;
    ...
    var int13 = (int2 - int8);
    int9 = (4 + 4);
    var int14 = (((35 + 2) + 2) + enum_getvalue(25, 0, 8549, 26));
    int13 = MAX(int13, int14);
    int2 = (int8 + ((((int13 - (35 + 2)) - enum_getvalue(25, 0, 8549, 26)) - (2 * 2)) / 2));
