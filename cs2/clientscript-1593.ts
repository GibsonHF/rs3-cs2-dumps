//
function script1593(int0: number, int1: number): void {
    var int2 = script8049(int1, 72679462);
    var int3 = script8049(int1, 72679447);
    var int4 = script8049(int1, 72679457);
    var int5 = script8049(int1, 72679458);
    var int6 = script8049(int1, 72679460);
    var int7 = script8049(int1, 72679461);
    var int8 = script8049(int1, 72679459);
    var int9 = script8049(int1, 72679445);
    var int10 = script8049(int1, 72679446);
    var int11 = script8049(int1, 72679443);
