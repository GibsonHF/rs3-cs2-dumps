//
function script10342(int0: number, int1: number, int2: number, int3: number, int4: number): void {
    ...
    varclient_4500 = script1552(varclient_4500, varclient_4499, 26, int0, -1);
