//
function script18654(int0: number, int1: number, string0: string): string {
    ...
    string0 = `${string0}<br>- <sprite=14216><nbsp><col=ffffff>${struct_getparam(14686, 2794)}:</col> ${script17711(15, 1)}.`;
