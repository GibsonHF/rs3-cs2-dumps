...
function script14900(int0: number): void {
    ...
    script13998(int1, int2, 28556, 0, 0, IF_GETWIDTH(int1), IF_GETHEIGHT(int1), 0, int4, "", script9670(varclient_6758, -2));
    script152(int1, (IF_GETWIDTH(int1) - 20), (IF_GETHEIGHT(int1) - 20), 10, 10, 26, string1, 16777215);
    CC_SETTEXTALIGN(1, 0, 0);
    script14874(int1, 0, 30, IF_GETWIDTH(int1), 30, string2, "", 1);
    if ((CC_FIND(int2, 0) == 1)) {
        CC_SETOP(1, string3);
        CC_SETOP(2, string4);
        CC_SETOPCURSOR(1, 46);
