//
function script12658(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number): string {
    if (((int1 != -1) && (STRING_LENGTH(struct_getparam(int1, 8685)) > 0))) {
