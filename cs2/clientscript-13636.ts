//
function script13636(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, string0: string): void {
    ...
    script7924(int5, IF_GETNEXTSUBID(int5), struct_getparam(int3, 7271), struct_getparam(int3, 7271), (int0 - struct_getparam(int3, 7271)), (int1 - struct_getparam(int3, 7271)), struct_getparam(int3, 7272), 1, 0, 0, 0);
    return;
}