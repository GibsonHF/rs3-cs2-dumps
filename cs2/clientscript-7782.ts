...
function script7782(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number): [number, number, number] {
    ...
    switch (int3) {
        case 44551: {
            int9 = MIN(int9, script7783(39822, int4, 1, int6, int7, int8));
            if ((int9 < int4)) {
                int14 = 1;
            };
        ...
        case 47515: {
            int9 = MIN(int9, script7783(6573, int4, 1, int6, int7, int8));
            int9 = MIN(int9, script7783(47506, int4, 50, int6, int7, int8));
            if ((int9 < int4)) {
                int14 = 1;
            };
        ...
        if ((int9 > 0)) {
            ...
            if ((int10 != -1 as obj)) {
                ...
                if ((int11 != -1 as obj)) {
                    ...
                    script7792(93, OC_CERT(int11), int13);
                };
            };
        };
        if ((int0 == 0)) {
