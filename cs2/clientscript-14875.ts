//
function script14875(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number): number {
    var int8 = int3;
    var int9 = int4;
    ...
    while ((++int13 < 5)) {
        ...
        script10410(int0, int1, 28575, int8, int9, 60, 60, (int7 + int13), 0, "");
        if ((int13 >= int11)) {
            script7924(int0, IF_GETNEXTSUBID(int0), 50, 50, (int8 + 5), (int9 + 5), 26605 as graphic, 0, 0, 0, 0);
        ...
        } else if ((int0 == 45416489)) {
            script7924(int0, IF_GETNEXTSUBID(int0), 36, 36, (int8 + 12), (int9 + 12), 18945 as graphic, 0, 0, 0, 0);
        };
    };
    return 0;
}