...
function script1037(int0: number, int1: number, int2: number): void {
    ...
    IF_SETHIDE(false, script8594(int2));
    IF_SETHIDE(true, script8598(int2));
    IF_SETHIDE(true, script8599(int2));
    IF_SETHIDE(false, script8600(int2));
    IF_SETCOLOUR(16777215, script8600(int2));
    IF_SETTEXTFONT(26 as fontmetrics, script8600(int2));
