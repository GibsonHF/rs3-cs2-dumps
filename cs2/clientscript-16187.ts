//
function script16187(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, string0: string, string1: string): number {
    var int6 = 0;
    ...
    script7863(int3, int2, 1, 1, int0, 5, 5, 0, 0, 20, 20, 0, 0, 17270, "+");
