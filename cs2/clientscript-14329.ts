//
function script14329(int0: number, int1: number, int2: number): void {
    var int3 = 0;
    var int4 = -1;
    switch (int2) {
        case 92274702: {
            script14331(varbitplayer_18339, 19805, int1, int2);
        ...
        case 92274715: {
            script14331(varbitplayer_18341, 19809, int1, int2);
            IF_SETONVARTRANSMIT(callback(script14330, int1, int2, 3594, 1), int0);
            break;
        }
        case 92274717: {
            script14331(varbitplayer_18342, 19819, int1, int2);
            IF_SETONVARTRANSMIT(callback(script14330, int1, int2, 3594, 1), int0);
            break;
        }
        case 92274719: {
            script14331(varbitplayer_18343, 19814, int1, int2);
            IF_SETONVARTRANSMIT(callback(script14330, int1, int2, 3594, 1), int0);
            break;
        }
        case 92274721: {
            script14331(varbitplayer_18344, 19824, int1, int2);
            IF_SETONVARTRANSMIT(callback(script14330, int1, int2, 1200, 1), int0);
            break;
        }
        case 92274723: {
            script14331(varbitplayer_18345, 28085, int1, int2);
