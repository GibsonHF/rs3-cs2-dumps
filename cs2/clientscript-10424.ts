//
function script10424(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number, int10: number, int11: number, int12: number, int13: number, int14: number, int15: number): void {
    ...
    if ((int19 != -1 as struct)) {
        ...
        if (((CC_FIND(int0, (int31 + 0)) == 1) && (int13 == 0))) {
            CC_SETOP(1, "Decrease");
    ...
    if ((int18 != -1 as struct)) {
        ...
        if (((CC_FIND(int0, (int31 + 7)) == 1) && (int13 == 0))) {
            CC_SETOP(1, "Increase");
            CC_SETONOP(callback(script10447, int0, int1, int2, int31, int11, int12, 1, int4, int5, int14, int15));
        };
    } else {
    ...
    if (((int13 == 0) && (CC_FIND(int0, (int31 + 19)) == 1))) {
