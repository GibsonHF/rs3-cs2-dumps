//
function script11142(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number, int7: number, int8: number, int9: number): void {
    var int10 = (int2 * 40);
    ...
    if ((((int1 != -1) && (int3 != -1)) && (CC_FIND[1](int1, item_getparam(int3, 4882)) == 1))) {
        CC_SETHIDE[1](0);
