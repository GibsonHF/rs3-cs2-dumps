//
function script1044(int0: number, int1: number): void {
    script8543(int1);
    script8618(int1, -1);
    ...
    IF_SETHIDE(false, script8586(int1));
    IF_SETHIDE(true, script8588(int1));
    IF_SETHIDE(false, script8590(int1));
    IF_SETHIDE(true, script8594(int1));
    IF_SETHIDE(true, script8598(int1));
    IF_SETHIDE(true, script8599(int1));
    IF_SETHIDE(false, script8600(int1));
    IF_SETCOLOUR(16777215, script8600(int1));
    IF_SETTEXTFONT(26 as fontmetrics, script8600(int1));
    ...
    define_array(250);
    var int7 = 0;
    string0 = enum_getvalue(0, 36, int2, 0);
    while ((strcmp("", string0) != 0)) {
        if ((int5 < 250)) {
