...
function script20255(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): number {
    ...
    var int13 = 1;
    var int14 = 4;
    script15938(94568455, int1, 0, int7, 0, 0, 0, 140, 0, 0, 1);
    script10033(int1, 1, 0, 0, 0, 0, 0, 0, 1, 1, 4128);
    script10485(int1, 2, 10, 4, 0, 0, 0, 20, 1, 0, 2141, `Tier ${inttostring((int1 + 1), 10)}`);
    CC_SETTEXTALIGN(0, 1, 0);
    script20259(int6, int8);
    script10485(int1, 3, 10, 4, 2, 0, 0, 20, 1, 0, 2141, `${inttostring(int9, 10)} x XP`);
