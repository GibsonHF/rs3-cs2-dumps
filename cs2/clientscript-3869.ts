...
function script3869(): void {
    ...
    if (((struct_getparam(varclient_4485, 6415) != 1) && (MAP_MEMBERS() == 0))) {
        [int0, int1] = script3870(0, -1, 23835, "To fight this boss, you must log into a members' world.", int0, int1);
    };
    while ((int2 < 12)) {
        [int6, int7, int8, int9] = [1, -1, -1, -1];
        switch (int2) {
            case 0: {
        ...
        if ((int3 > 0)) {
            if ((int3 < 60)) {
                [int8, string0] = [enum_getvalue(0, 23, 8548, int3), `You must have level ${inttostring(int4, 10)} ${enum_getvalue(0, 36, 108, int3)}.`];
                if ((STAT_BASE(enum_getvalue(0, 17, 681, int3)) < int4)) {
                    int6 = 0;
                };
            } else if ((int3 == 60)) {
                ...
                if ((int9 != -1)) {
                    if ((struct_getparam(int9, 1345) > 0)) {
                        int8 = script2107(enum_getvalue(0, 3, 2252, struct_getparam(int9, 1345)));
                    } else {
                ...
                int8 = script2107(enum_getvalue(0, 3, 2252, int4));
                string0 = `You must complete the quest: '${script2103(enum_getvalue(0, 3, 2252, int4))}'`;
