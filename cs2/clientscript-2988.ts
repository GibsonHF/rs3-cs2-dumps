//
function script2988(int0: number): void {
    var string0 = "null";
    var string1 = "null";
    var string2 = "null";
    var int1 = -1;
    ...
    IF_SETHIDE(1, 4718601);
    IF_SETHIDE(0, 4718602);
    IF_SETTEXT(string0, 4718595);
    IF_SETTEXT(string1, 4718596);
    IF_SETTEXT(string2, 4718597);
    IF_SETMODEL(int1, 4718594);
    return;
}