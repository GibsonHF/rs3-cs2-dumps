...
function script3701(): void {
    ...
    if ((varbitplayer_5443 == 1)) {
        ...
        if ((int0 != -1 as cs2enum)) {
            string0 = enum_getvalue(0, 36, 8616, varbitplayer_5451);
            string1 = enum_getvalue(0, 36, int0, varbitplayer_5455);
        };
    } else if ((varbitplayer_5448 == 1)) {
        string0 = enum_getvalue(0, 36, 8617, varbitplayer_5451);
        string1 = enum_getvalue(0, 36, 1778, varbitplayer_5455);
    } else if ((varbitplayer_11728 == 1)) {
        string1 = enum_getvalue(0, 36, 5401, varbitplayer_5455);
    } else if ((varbitplayer_11727 == 1)) {
        string1 = enum_getvalue(0, 36, 5400, varbitplayer_5455);
    } else if ((varbitplayer_5450 == 1)) {
        string1 = enum_getvalue(0, 36, 6081, varbitplayer_5455);
    };
    var string2 = strconcat(string0, " ");
    string2 = strconcat(string2, string1);
    IF_SETTEXT(string2, comp(570, 99));  // crcs_info_overlay:audience_request
    return;
}