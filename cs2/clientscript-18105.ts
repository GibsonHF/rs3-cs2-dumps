...
function script18105(int0: number, int1: number, int2: number, int3: number, int4: number): [number, number] {
    ...
    stack(int1);
    var int1 = (int1 + 1);
    script17947(0, int5, 1, 0, (2 * 2), (58 + (2 * 2)), 1, 1, int6);
    CC_GETDYNAMICLAYER();
    int5 = (int5 + 5);
    var int7 = int1;
    ...
    while ((int12 < int13)) {
        ...
        stack(int1);
        int1 = (int1 + 1);
        script10028(0, int5, 1, 0, int11, 35, 0, 0, 0, 5);
        int5 = (int5 + (35 + 5));
        CC_GETDYNAMICLAYER();
        int12 = (int12 + 1);
    };
    ...
    while ((int18 < int19)) {
        ...
        if ((CC_FINDBYCATEGORY(comp(403, 9), int0, int7) == 1)) {  // bp3_buffs_tab:xp_buff_content_layer
            ...
            if ((enum_hasoutput(17, int8, int16) == 1)) {
                if ((int16 != -1)) {
                    ...
                    stack(int1);
                    int1 = (int1 + 1);
                    script7918(0, 0, 0, 0, 35, 35, 0, 0, enum_getvalue(0, 23, 8548 as cs2enum, int15));
                    script3537(`+${TOSTRING_LOCALISED(int3, 1)}% base ${enum_getvalue(17, 36, 680 as cs2enum, int16)} XP`);
                } else {
                    stack(int0);
                    stack(int1);
                    int1 = (int1 + 1);
                    script15937(0, 0, 0, 0, 35, 35, 0, 0);
                    stack(int0);
                    stack(int1);
                    int1 = (int1 + 1);
                    script7918(0, 0, 0, 0, 35, 35, 0, 0, enum_getvalue(0, 23, 8548, int15));
                    stack(int0);
                    stack(int1);
                    int1 = (int1 + 1);
                    script7918(0, 0, 0, 0, 35, 35, 0, 0, 25889);
                    script3537(`${enum_getvalue(17, 36, 680, int16)} is excluded from this buff.`);
                    int14 = -1;
                };
                int17 = (int17 + 1);
            };
    ...
    var int20 = 0;
    var int21 = 0;
    if ((CC_FINDBYCATEGORY(comp(403, 9), int0, 0) == 1)) {  // bp3_buffs_tab:xp_buff_content_layer
        ...
        stack(int1);
        int1 = (int1 + 1);
        script10485(0, int5, 1, 0, int20, int21, 0, 0, 8000, string0);
        int5 = (int5 + int21);
    };
    return [int1, (int5 + 10)];
}