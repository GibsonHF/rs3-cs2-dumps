//
function script6794(int0: number, int1: number, int2: number, int3: number, int4: number, int5: number, int6: number): number {
    ...
    if ((int3 == 94 as inv)) {
        ...
        switch (int9) {
            ...
            case 8: {
                ...
                int8 = (2147483647 - script14347(94, int4));
                if ((int8 >= int1)) {
                    int8 = 0;
                } else {
                    int8 = (int1 - int8);
        ...
        if (((varplayer_1831 == -1 as obj) || (varplayer_1784 == -1 as npc))) {
            ...
            int8 = script3970(95, int0, int1, -1, int7);
            if ((int8 == int1)) {
                script14187();
                script14183();
                return 0;
