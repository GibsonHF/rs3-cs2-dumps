//
function script10319(int0: number): void {
    ...
    if ((PLAYER_GROUP_FIND() == 1)) {
        ...
        script10328(int0, -1);
        IF_SETHIDE(1, script10306(int0));
        IF_SETHIDE(1, script4244(int0));
        IF_SETSIZE(0, 33, 1, 1, script10310(int0));
        CC_DELETEALL(int1);
        CC_DELETEALL(int2);
        CC_DELETEALL(int3);
        script10629(int1, IF_GETNEXTSUBID(int1), IF_GETWIDTH(int1), IF_GETHEIGHT(int1), 0, 0, "You are not currently in a group.", 16777215, 28, 1, 1, 13, 0);
    };
    return;
}